...
**Generated:** 2/21/2026, 7:29:30 AM
...
❌ **Validation failed** - 1 file(s) have errors that must be fixed.
...
1 error(s) found that must be fixed:
...
28 warning(s) found (recommended to fix):
...
2. **[builds-on]** Field "builds-on" uses kebab-case — rename to "buildsOn" (camelCase required)
...
**Report Generated:** 2026-02-21T07:29:30.752Z
