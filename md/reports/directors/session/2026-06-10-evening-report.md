...
| Gates clean | audit-architecture, audit-suite-sync, template-contract |
...
- The committed sibotacademy.pl report still carries the old framing it was generated under; regenerate it with the fixed pipeline when convenient to ship the corrected version.
