...
mx:
  ...
  audience: business
  confidential: true
  canonicalUri: https://raw.githubusercontent.com/Digital-Domain-Technologies-Ltd/MX-outputs/main/md/reports/directors/session/2026-03-16-evening-report.md
  purpose: "Co-Directors Report - Chapter 15 + Agentica Onboarding + Reginald Compliance Engine"
  stability: stable
  runbook: "Reference material. Read for context; not an instruction set."
  x-mx-contextProvides: ["Co-Directors Report - Chapter 15 + Agentica Onboarding + Reginald Compliance Engine"]
