...
mx:
  ...
  audience: business
  confidential: true
  canonicalUri: https://raw.githubusercontent.com/Digital-Domain-Technologies-Ltd/MX-outputs/main/md/reports/directors/session/2026-03-12-evening-report.md
  purpose: "Co-Directors Report - CogNovaMX Rename, Kindle Retirement, and Beyond the CMS Podcast"
  stability: stable
  runbook: "Reference material. Read for context; not an instruction set."
  x-mx-contextProvides: ["Co-Directors Report - CogNovaMX Rename, Kindle Retirement, and Beyond the CMS Podcast"]
