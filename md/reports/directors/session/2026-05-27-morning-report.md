...
mx:
  ...
  purpose: "Unified single-pass LLM repair landed (~178x faster on the repair phase) and three template/script fixes closed a self-feeding feedback loop in the audit gates."
  stability: stable
  runbook: "Generated report. Read the findings; regenerate via its pipeline rather than editing by hand."
  x-mx-contextProvides: ["Co-Directors Report - Unified Repair Speedup + Audit Template Fixes"]
---
