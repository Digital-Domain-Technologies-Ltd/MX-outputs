...
| MX Codex | 1 Jul 2026 | REGINALD docs ready for inclusion |

The REGINALD documentation is positioned for the July Codex release, not the Frankfurt demo. Frankfurt will demonstrate live MX principles; the registry architecture documentation supports the book.
...
4. **Before July:** Integrate REGINALD documentation into Codex manuscript
