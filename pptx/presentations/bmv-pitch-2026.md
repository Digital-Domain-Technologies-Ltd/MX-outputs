...
mx:
  ...
  purpose: "15-slide investor pitch deck for Bare Metal Ventures meeting with Michelle Tang."
  stability: stable
  runbook: "Reference material. Read for context; not an instruction set."
  x-mx-contextProvides: ["MX - Bare Metal Ventures Pitch"]
---

# MX — Bare Metal Ventures Pitch
...
Built on Markdown, YAML, and HTML. Nothing proprietary. Nothing to install. Nothing to lock in.
...
- Frontier models capable of acting on structured input
- Inference cost makes structural ambiguity expensive at enterprise scale
- Regulatory pressure on AI provenance — EU AI Act, UK AI assurance regime

Adobe Holiday 2025: 700% growth in AI-referred retail traffic. AI-referred users converting 30% higher than direct. Human browsing is becoming the exception.
...
- **Top-right (open + executable): MX OS — alone**
...
| E2B | $21M Series A | No | No | No |
| Cognition | $175M @ $2B | No | No | No |
| **MX OS** | **Pre-seed** | **Yes** | **Yes** | **Yes** |
...
|---|---|---|
| Mid-size law firm | 2 | £50,000 |
| Regional bank | 5 | £125,000 |
| Global bank (per division) | 10–20 | £250,000–£500,000 |
| Government department | 5–10 | £125,000–£250,000 |
| Defence contractor | 10+ | £250,000+ |

- Ten enterprise clients at 5 servers average: **£1.25M ARR from on-prem alone**, before a single SaaS subscription.
...
- **Contact:** info@cognovamx.com | Tom Cranstoun
