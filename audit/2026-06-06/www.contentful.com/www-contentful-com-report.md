...
We last audited www.contentful.com on 3 June 2026. The table compares that audit with the current one across the headline measures. Every headline score is unchanged from that audit, so the recommendations from that audit remain open.

| Measure | 3 June 2026 | 6 June 2026 | Change |
|---------|------:|------:|:-------|
