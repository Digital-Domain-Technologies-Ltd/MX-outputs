---
title: "Web Audit Suite Report Template"
description: "Client-facing website analysis template v2.0: compact structure, visual scorecard, triage table, clear call-to-action"
...
Write 2–3 sentences summarising the audit findings for results. IMPORTANT: Always refer to the site by its domain (results), never by the consultancy name.
