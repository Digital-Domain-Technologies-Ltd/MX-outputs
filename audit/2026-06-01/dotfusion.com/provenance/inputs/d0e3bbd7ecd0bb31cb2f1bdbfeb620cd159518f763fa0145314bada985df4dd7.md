...
reportId: "Dotfusion-WEB-AUDIT-20260601"
...
mx:
  ...
  canonicalUri: https://raw.githubusercontent.com/Digital-Domain-Technologies-Ltd/MX-outputs/main/audit/2026-06-01/dotfusion.com/Dotfusion-report.md
  ...
  generate:
    ...
    format: "pdf"
    output: "mx-outputs/audit/2026-06-01/dotfusion.com/Dotfusion-report.pdf"
...
**Date:** 1 June 2026\
**Report ID:** Dotfusion-WEB-AUDIT-20260601
...
The full per-entity list is delivered alongside this report as a sidecar CSV: [`Dotfusion-structured-data-findings.csv`](Dotfusion-structured-data-findings.csv). The 67 rows describe individual Schema.org property gaps on specific entities; most of them share a small number of underlying patterns, shown below ranked by instance count.
...
- **Truncation Risk** - Fail · 5/12
  ...
  - *Data:* Largest page: 471 KB. Thresholds: 250 KB hard ceiling; 50/75/100 KB content-offset windows. See Dotfusion-pipeline-truncation-risk-pages.csv (5 pages).
