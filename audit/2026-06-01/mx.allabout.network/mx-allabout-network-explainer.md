...
URL: https://mx.allabout.network  Date: 2026-06-01  Run ID: 4i1dowf9y

## COLLECT - 2026-06-01 20:04:50
...
| 2 | wellknown-probe | COLLECT | 15.1s | pass |  |
| 3 | clear-results | COLLECT | 0.0s | pass |  |
| 4 | ai-usage-check | COLLECT | 3.3s | pass |  |
| 5 | sitemap-discovery | COLLECT | 0.8s | pass | https://mx.allabout.network/sitemap.xml |
| 6 | crawler | COLLECT | 26m 11s | pass |  |
| 7 | url-discovery | COLLECT | 0.8s | pass |  |
| 8 | pdf-topup | COLLECT | 0.1s | pass |  |
| 9 | pdf-sample | COLLECT | 0.2s | pass |  |
| 10 | error-page-test | COLLECT | 0.6s | pass |  |
| 11 | agent-access-test | COLLECT | 21.2s | pass |  |
| 12 | served-rendered-gap | COLLECT | 0.1s | pass |  |
| 13 | slowest-page-probe | COLLECT | 5m 34s | pass |  |
...
1. crawler - 26m 11s
2. slowest-page-probe - 5m 34s
3. agent-access-test - 21.2s

---

## REPORT - 2026-06-01 20:10:05
...
| 21 | gate-4d-provenance | GATES | 13.4s | pass |  |
| 22 | gate-5-pdf | GATES | 6.8s | pass | mx-outputs/audit/2026-06-01/mx.allabout.network/mx-allabout-network-report.pdf |
...
1. gate-3-fierce-critic - 2m 5s
2. gate-4-llm-judgment - 1m 39s
3. unified-repair - 1m 5s

---

## GATES - 2026-06-02 07:40:20
...
| 14 | gate-1 | GATES | 0.1s | pass |  |
| 15 | gate-2 | GATES | 0.3s | pass |  |
| 16 | gate-3-fierce-critic | GATES | 2m 8s | pass |  |
| 17 | gate-4-llm-judgment | GATES | 1m 48s | pass |  |
| 18 | unified-repair | GATES | 3m 27s | pass |  |
| 19 | gate-4b | GATES | 0.1s | pass |  |
| 20 | gate-4c | GATES | 0.6s | pass |  |
| 21 | gate-4d-provenance | GATES | 20.7s | pass |  |
| 22 | gate-5-pdf | GATES | 12.2s | pass | mx-outputs/audit/2026-06-01/mx.allabout.network/mx-allabout-network-report.pdf |
...
| Metric | Value |
|--------|-------|
| Total elapsed | 7m 59s |
| Steps completed | 22 |
| Steps skipped | 0 |

**Slowest steps:**

1. unified-repair - 3m 27s
2. gate-3-fierce-critic - 2m 8s
3. gate-4-llm-judgment - 1m 48s

---

## GATES - 2026-06-02 07:48:15
...
| 18 | unified-repair | GATES | 1m 13s | pass |  |
| 19 | gate-4b | GATES | 0.1s | pass |  |
| 20 | gate-4c | GATES | 0.7s | pass |  |
| 21 | gate-4d-provenance | GATES | 27.2s | pass |  |
| 22 | gate-5-pdf | GATES | 7.0s | pass | mx-outputs/audit/2026-06-01/mx.allabout.network/mx-allabout-network-report.pdf |
