...
SCOPE: 128 pages were audited. Scope all claims to "the audited set" - do not say "site-wide" unless cross-page consistency is explicitly confirmed in the facts.
...
Facts (do not change any number, percentage, URL, page count, or name):
- Pages audited: 128
- Performance: 414ms avg (Excellent)
...
- Security headers: 5/5 present (HTTPS, HSTS, CSP, X-Frame-Options, X-Content-Type-Options); 133 of 134 audited URLs carry all five
- Structured Data Quality: 92/100
- Consistency: 99%
-->
...
- Div Soup audited page count: 134
...
FACTS (do not change any number, percentage, URL, page count, or name):
- Pages audited: 128 - scope all Priority descriptions to "the audited page" (singular) or "the audited set" (plural); do NOT say "site-wide" or "across the site"
...
- Performance: 414ms average load time
...
| WebPage | 100 | 100% | 100% | Website, WebSite, Organization, Person |
| BreadcrumbList | 98 | 100% | 100% | - |
| Offer | 17 | 97% | 100% | Organization, Service, PriceSpecification, Country |
| BlogPosting | 65 | 100% | 100% | Person, Organization, Reference, Website |
| ImageObject | 41 | 100% | 100% | - |
| Organization | 44 | 100% | 100% | Person, ContactPoint, Reference, Website |
| Person | 42 | 100% | 100% | Organization, PropertyValue |
...
- Pages affected by that check: 1 of 126
...
- Pages contributing to the Div Soup aggregation: 134
...
DO_NOT:
- Say "site-wide" unless consistency was explicitly confirmed. 128 pages were audited; scope claims to "the audited set".
-->
