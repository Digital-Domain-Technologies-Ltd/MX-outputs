...
- Add `author` and `publisher` entities to the WebSite block, linked by JSON-LD identifier cross-references so a single `Organization` or `Person` entity defined once is referenced from each page.
...
| Full Optimization | P1, P2, P3, P4 (P1–P4) | Full machine readiness — every agent, search engine, and structured-data consumer can read, trust, and act on the site |
