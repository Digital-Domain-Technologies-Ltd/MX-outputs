...
|--------|--------------|----------------|--------------------|------------|
| Rendered HTML | 34/100 (high) | 292 bare divs - 51% ratio - depth 7 | `div` (242), `div.grid-helper-col.col-span-1` (144), `div.tooltip_root__EulUk` (95), `div.button_markup_root__sACGr.button_markup_secondary__F_qxS` (68), `div.round-icon.round_icon_container__Jmlwp` (57) | <https://www.contentful.com/products/personalization/> |
