...
| 6 | crawler | COLLECT | 12.5s | pass |  |
| 7 | url-discovery | COLLECT | 1.8s | pass |  |
| 8 | pdf-topup | COLLECT | 0.1s | pass |  |
| 9 | pdf-sample | COLLECT | 0.1s | pass |  |
| 10 | error-page-test | COLLECT | 1.6s | pass |  |
| 11 | agent-access-test | COLLECT | 36.4s | pass |  |
| 12 | served-rendered-gap | COLLECT | 0.1s | warn |  |
| 13 | slowest-page-probe | COLLECT | 5m 29s | warn |  |
| 14 | ab-test-detection | COLLECT | 0.3s | pass |  detected |
| 15 | provenance-gap-deterministic | COLLECT | 0.6s | pass |  |
| 16 | provenance-gap-llm | COLLECT | 1m 12s | pass |  |
| 17 | generate-preflight | COLLECT | 0.1s | pass |  |
...
1. slowest-page-probe - 5m 29s
2. provenance-gap-llm - 1m 12s
3. agent-access-test - 36.4s

---

## REPORT - 2026-06-02 21:27:35
...
| 1 | template-voice-check | REPORT | 0.1s | pass |  |
| 2 | infill-pass1 | REPORT | 0.5s | pass |  |
| 3 | rewrite-pass2 | REPORT | 4m 56s | pass |  |
| 4 | engagement-table-regen | REPORT | 0.1s | pass |  |
| 5 | error-section-regen | REPORT | 0.1s | pass |  |
...
| Metric | Value |
|--------|-------|
| Total elapsed | 4m 57s |
| Steps completed | 5 |
| Steps skipped | 0 |

**Slowest steps:**

1. rewrite-pass2 - 4m 56s
2. infill-pass1 - 0.5s
3. template-voice-check - 0.1s

---

## GATES - 2026-06-02 21:31:53
...
| 17 | gate-4-llm-judgment | GATES | 1m 49s | warn |  |
| 18 | unified-repair | GATES | 0.2s | pass |  |
| 19 | gate-4b | GATES | 0.1s | pass |  |
| 20 | gate-4c | GATES | 0.6s | warn | 1 finding(s) |
| 21 | gate-4d-provenance | GATES | 25.5s | pass |  |
| 22 | gate-5-pdf | GATES | 7.2s | pass | mx-outputs/audit/2026-06-02/crowdfavorite.com/crowdfavorite-com-report.pdf |
...
2. gate-4-llm-judgment - 1m 49s
3. gate-4d-provenance - 25.5s
