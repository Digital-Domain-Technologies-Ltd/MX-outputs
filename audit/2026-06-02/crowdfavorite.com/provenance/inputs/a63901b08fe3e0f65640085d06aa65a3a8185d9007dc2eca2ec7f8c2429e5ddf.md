...
- **WCAG 4.1.2**: This element has role of "button" but does not have a name available to an accessibility API. Valid names are: element content, aria-label , aria-labelledby . | selector: `#cmplz-cookiebanner-container > div > div:nth-child(1) > div…` | 11 instances on 11 pages | affects: screen reader users
- **WCAG 1.1.1**: Img element is the only content of the link, but is missing alt text. The alt text should describe the purpose of the link. | selector: `html > body > div:nth-child(4) > header > div:nth-child(1) >…` | 10 instances on 10 pages | affects: screen reader users
- **WCAG 1.1.1**: Img element missing an alt attribute. Use the alt attribute to specify a short text alternative. | selector: `html > body > div:nth-child(4) > header > div:nth-child(1) >…` | 10 instances on 10 pages | affects: screen reader users
- **WCAG 1.1.1**: Img element missing an alt attribute. Use the alt attribute to specify a short text alternative. | selector: `html > body > div:nth-child(4) > header > div:nth-child(1) >…` | 10 instances on 10 pages | affects: screen reader users
- **WCAG 1.1.1**: Img element missing an alt attribute. Use the alt attribute to specify a short text alternative. | selector: `html > body > div:nth-child(4) > header > div:nth-child(1) >…` | 10 instances on 10 pages | affects: screen reader users
...
- **WCAG 1.1.1**: Img element missing an alt attribute. Use the alt attribute to specify a short text alternative. | selector: `html > body > div:nth-child(4) > header > div:nth-child(1) >…` | 10 instances on 10 pages | affects: screen reader users
- **WCAG 1.1.1**: Img element missing an alt attribute. Use the alt attribute to specify a short text alternative. | selector: `html > body > div:nth-child(4) > header > div:nth-child(1) >…` | 10 instances on 10 pages | affects: screen reader users
- **WCAG 1.1.1**: Img element missing an alt attribute. Use the alt attribute to specify a short text alternative. | selector: `html > body > div:nth-child(4) > header > div:nth-child(1) >…` | 10 instances on 10 pages | affects: screen reader users above.
