...
We find that the site delivers a strong experience for human visitors, with good performance and accessibility and excellent SEO across the audited set.
...
|-----------|-------|------------|
| Performance | Good | Good - 3569ms average load time |
...
| Agent access | 5/7 | 5 of 7 AI user-agents receive HTTP 200; ClaudeBot (Anthropic), GPTBot (OpenAI) blocked |
...
We summarise key opportunities across the audited set, prioritised by impact on machine comprehension and discovery. Catalogue Visibility, with a score of 15/100, is the highest priority, followed by Discovery Readiness (40/100), MX Stack Completeness (73/100), and Structured Data Quality (90/100).

# | Finding | Bucket | Priority | Effort | Impact  
--- | --- | --- | --- | --- | ---  
1 | WCAG 4.1.2: Button role missing name | Compliance Risk | High | Medium | Screen reader users may miss button functionality.  
2 | WCAG 1.1.1: Image links missing alt | Compliance Risk | High | Medium | Screen reader users may miss link purpose.  
3 | Div Soup: Semantic structure 41/100 (worst page) | Compliance Risk | High | Medium | Screen reader users may miss content hierarchy.  
4 | Discovery Readiness: Missing llms-full.txt, agent-card.json, ai.txt, humans.txt | Machine Readability Opportunity | Medium | Low | Machines may not recognise content as a knowledge source.  

---  

**Priority 1: WCAG 4.1.2: Button role missing name**  

**Finding**  
WCAG 4.1.2: Button role missing name  

**What to change and why**  
- Add an accessible name to the button via aria-label or visible text.  
- This allows screen readers to announce the button.  
- It satisfies WCAG 4.1.2.  
...
**Priority 2: WCAG 1.1.1: Image links missing alt**  

**Finding**  
WCAG 1.1.1: Image links missing alt  

**What to change and why**  
- Add descriptive alt text to image links.  
- This ensures link purpose is conveyed to screen readers.  
- It satisfies WCAG 1.1.1.  
...
**Priority 3: Div Soup: Semantic structure 41/100 (worst page)**  

**Finding**  
Div Soup: Semantic structure 41/100 (worst page)  

**What to change and why**  
- Refactor the template to reduce bare divs, replacing them with semantic elements.  
- This improves content structure for assistive technologies.  
- It addresses the low semantic score.  
...
**Priority 4: Discovery Readiness: Missing llms-full.txt, agent-card.json, ai.txt, humans.txt**  

**Finding**  
Discovery Readiness: Missing llms-full.txt, agent-card.json, ai.txt, humans.txt  

**What to change and why**  
- Create llms-full.txt, agent-card.json, ai.txt, and humans.txt files.  
- These artefacts expose content to knowledge graphs and LLMs.  
- They improve discovery readiness score.  
...
**Summary:** 6 of 8 tested agents can access the site. 2 agent(s) returned non-200 responses: ClaudeBot (Anthropic), GPTBot (OpenAI).
...
| `<changefreq>` | No | Missing (TYPO3 sitemaps omit changefreq by default; Google dropped it as a ranking signal in 2017, but non-Google crawlers and AI agents use it to gauge re-crawl cadence) |
| `<priority>` | No | Absent (TYPO3 sitemaps omit priority by default; Google dropped it as a ranking signal in 2017, but it remains a relative-importance hint for non-Google crawlers and AI agents) |
