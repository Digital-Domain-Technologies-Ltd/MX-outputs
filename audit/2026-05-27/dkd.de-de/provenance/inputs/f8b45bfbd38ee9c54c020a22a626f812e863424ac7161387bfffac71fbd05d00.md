...
Every automated gate ran to completion; this section surfaces 3 findings (3 warnings) for the human reviewer to read, accept, or rebut before sign-off. Each entry names the gate that raised it, the severity, and the supporting evidence.
...
|---|------|----------|---------|----------|
| 1 | voice-consistency | mixed-voice-sections | Mixed-voice section(s) remain after auto-repair: 1 | 2026-05-27T16:36:59Z |
| 2 | sample-vs-total-scope | scope-mis-statements | Scope mis-statements remain after auto-repair: 1 | 2026-05-27T16:36:59Z |
| 3 | template-voice | template-voice-style | Template voice/style findings: 26 violation(s) | 2026-05-27T16:46:03Z |
...
check-report-voice: /Users/tomcranstoun/Documents/GitHub/MX-hub/mx-outputs/audit/2026-05-27/dkd.de-de/dkd-de-de-report.md
  ...
  ## Findings  (line 214)
    first-person tokens: 5 (lines 218, 250, 267…)
    third-person markers: 1 (lines 284)
...
check-report-scope: /Users/tomcranstoun/Documents/GitHub/MX-hub/mx-outputs/audit/2026-05-27/dkd.de-de/dkd-de-de-report.md
  ...
  [sampling-inside-sitewide-section] line 408
    section: ## Discovery Files  (line 370)
    phrase:  "across the audited set"
    line:    We found no llms.txt file present on dkd.de, meaning machines that query the host for a structured content index receive
...
**3. template-voice - Template voice/style findings: 26 violation(s)**
...
- Site: Dkd (dkd.de)
- Pages audited: 5 (full audit)
- Date: 2026-05-27
- Scores: SEO 92/100 | Accessibility 100/100 | Discovery Readiness 25/100 | Structured Data 66/100
- Scope: 5 pages audited - write "across the audited set", NEVER "site-wide"
- Schema types already present (do NOT recommend adding these): ListItem (12), Question (12), Answer (12), BreadcrumbList (5), WebSite (1), FAQPage (1)
...
- Accessibility: 0 distinct WCAG AA issue types (0 raw instances, 0 marked critical by Pa11y) - 283 of these instances trace to 57 recurring template patterns (single theme edit per pattern fixes all instances)
...
Facts (do not change any number, percentage, URL, page count, or name):
- Pages audited: 5
- Performance: 2025ms avg (Excellent)
- Accessibility: 100/100 (Excellent)
- SEO: 92/100 (Excellent)
- Accessibility issues: 0 distinct WCAG codes across 0 raw instances (283 instances trace to 57 template patterns)
-->
...
- Accessibility: 100/100 (0 distinct WCAG codes, 0 raw instances) - 283 of these instances trace to 57 template-level patterns
- Security headers: 5/5 present (HTTPS, HSTS, CSP, X-Frame-Options, X-Content-Type-Options); 0 of 5 audited URLs carry all five
- Structured Data Quality: 66/100
- Consistency: 62%
-->
...
FACTS:
- Pa11y data for this audit:  Of these, 283 (93%) trace to 57 recurring template-level patterns; a single theme edit per pattern resolves all instances site-wide.

Pa11y findings for this audit (use ONLY these for specific recommendations):
- **WCAG 4.1.1**: Duplicate id attribute value "accessibility" found on the web page. | selector: `#accessibility` | 5 instances on 5 pages | affects: all assistive tech users
- **WCAG 4.1.1**: Duplicate id attribute value "account" found on the web page. | selector: `#account` | 5 instances on 5 pages | affects: all assistive tech users
- **WCAG 4.1.1**: Duplicate id attribute value "alarm" found on the web page. | selector: `#alarm` | 5 instances on 5 pages | affects: all assistive tech users
- **WCAG 4.1.1**: Duplicate id attribute value "article" found on the web page. | selector: `#article` | 5 instances on 5 pages | affects: all assistive tech users
- **WCAG 4.1.1**: Duplicate id attribute value "bell" found on the web page. | selector: `#bell` | 5 instances on 5 pages | affects: all assistive tech users
...
- Div Soup audited page count: 5

When a Pa11y finding row in  Of these, 283 (93%) trace to 57 recurring template-level patterns; a single theme edit per pattern resolves all instances site-wide.
...
- Invent Pa11y findings (e.g. keyboard-navigation or focus-order issues) not listed in  Of these, 283 (93%) trace to 57 recurring template-level patterns; a single theme edit per pattern resolves all instances site-wide.
...
- **WCAG 4.1.1**: Duplicate id attribute value "alarm" found on the web page. | selector: `#alarm` | 5 instances on 5 pages | affects: all assistive tech users
- **WCAG 4.1.1**: Duplicate id attribute value "article" found on the web page. | selector: `#article` | 5 instances on 5 pages | affects: all assistive tech users
- **WCAG 4.1.1**: Duplicate id attribute value "bell" found on the web page. | selector: `#bell` | 5 instances on 5 pages | affects: all assistive tech users above.
...
- Accessibility: 100/100 (Excellent) - 0 issues - 283 trace to 57 template pattern(s)
- SEO: 92/100 (Excellent)
- Security headers: 5/5 present (HTTPS, HSTS, CSP, X-Frame-Options, X-Content-Type-Options); 0 of 5 audited URLs carry all five
- Heading quality: 87/100
- Pipeline Survivability: 76/100
- Served HTML: 79/100, Rendered HTML: n/a/100
- Performance: 2025ms average load time
...
- Pages affected by that check: 5 of 5
...
- Top bare selectors (rendered): `div.text-columns__column` (67), `div.text-columns.text-columns--` (21), `div.textpic.textpic--inside` (12), `div.text-columns.text-columns--above` (6), `div.blog-card__info` (4)
- Pages contributing to the Div Soup aggregation: 5
...
FACTS:
- Scores: AI Suitability: -/100; Accessibility: -/100; SEO: 92/100; Structured Data: 66/100; Discovery Readiness: 25/100
- Human visitors: served well
- Machine opportunity: structured data, discovery, metadata

DO_NOT:
- Say "site-wide" unless consistency was explicitly confirmed. 5 pages were audited; scope claims to "the audited set".
-->
...
- PNG: 8
- JPEG: 1
- Other / unrecognised formats: 28
- With alt text: 37 (100.0%)
- Missing alt text: 0
- loading="lazy": 37
- loading="eager": 0
