...
description: "Findings sidecar for the Typo3 audit on 2026-05-27. Records every gate finding (error, warning, info) raised during the run, for human sign-off and for a machine to consider, decide on, and action before delivery."
