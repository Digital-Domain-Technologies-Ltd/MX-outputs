...
reportId: "typo3-org-WEB-AUDIT-20260616"
reportType: "executive-sales-report"
auditTool: "web-audit-suite"
auditDate: "2026-06-16"
auditCommand: "node scripts/audit-pipeline.js https://typo3.org --pages 10"
...
mx:
  ...
  canonicalUri: https://raw.githubusercontent.com/Digital-Domain-Technologies-Ltd/MX-outputs/main/audit/2026-06-16/typo3.org/typo3-org-report.md
...
**Date:** 16 June 2026\
**Report ID:** typo3-org-WEB-AUDIT-20260616
...
Across the audited set, your content delivers a smooth experience for visitors. Performance is excellent, with fast load times that keep users engaged, and SEO foundations are solid, helping search engines surface your pages. The design and clear navigation reinforce brand trust.  

The headline opportunity is to enrich the pages with MX governance metadata so machines have the structured context they need for accurate comprehension. Adding full MX fields-mx:status, mx:contentType, mx:audience, canonicalUri, provenance markers-will lift your MX Readiness Level from Discoverable to Governed and raise MSC above 60 and DR above 40. Introducing Schema.org JSON-LD will give every agent a reliable data source regardless of rendering.
...
Across the audited set, we see a strong experience for human visitors, with excellent performance and accessibility scores, while SEO offers an area for improvement.
...
Across the audited set, machines can discover and parse content-our Discovery Readiness score of 25/100 and Structured Data Quality of 0/100 confirm a Level 1 (Discoverable) state, while MX Stack Completeness at 52/100 and Pipeline Survivability at 96/100 show that the technical foundation is largely intact but governance metadata remains absent.
...
Across the audited set, we find a strong foundations in accessibility (100/100) and SEO (75/100) that sets the groundwork for further enhancements. These strengths give us confidence as we move forward with targeted improvements.
...
Across the audited set, Inline Tag Bloat appears on five of twelve pages and can cause machines to truncate or miss parts of the page, limiting their ability to index all content. Truncation Risk also flags some pages, meaning agents may receive incomplete data if payload limits are exceeded. Reducing inline markup-by moving styles and scripts to external files-offers the largest opportunity for strengthening machine comprehension.
...
We find that the served surface has the highest bare-div ratio-216 of 288 elements (75 %) on the worst page (https://typo3.org/association)-so machines lose structural context and fall back to positional inference.  
The soup contains deep chains of seven nested bare divs, indicating a source pipeline that relies on drag-and-drop builders or untyped component frameworks rather than semantic markup.  
We recommend a cost-effective first move of wrapping the primary landmarks-header, nav, main, footer, aside-and giving remaining divs meaningful class names to reduce the bare-div ratio without restructuring the layout.
...
We noted that accessibility legislation worldwide converges on ISO 14289-1 (PDF/UA) as the technical baseline, with the European Accessibility Act providing a highly detailed example of this alignment. We also observed that an untagged PDF remains invisible to machines; without a proper structure tree, search crawlers and AI systems cannot extract text, entities or structure from scanned or image-based PDFs.
...
Analysis of text patterns across audited pages found content reaching Probably AI on the AI-tells scale (9 of 12 pages scored). Machines do not consistently cite or label AI-generated content; this observation describes what the analysis found, not a conclusion about authorship. The full per-page breakdown is in `ai-tells.json` in the results directory.
...
Accessibility scores 100/100, showing that your content is fully accessible to all users. Across the audited set, Structured Data sits at 0/100 and Discovery Readiness at 25/100, indicating significant opportunities for improving how machines understand and find your pages. We invite you to act on these findings to enhance machine comprehension and discoverability.
...
**Scope:** 12 pages examined | Platform: Unknown Platform | Frameworks: **Bootstrap** (low confidence) -  CSS framework | Analysis method: Hybrid (automated + manual verification) | robots.txt: Absent (HTTP 404)
