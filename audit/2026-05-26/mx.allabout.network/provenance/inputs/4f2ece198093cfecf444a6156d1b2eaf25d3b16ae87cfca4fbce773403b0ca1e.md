...
/Users/tomcranstoun/Documents/GitHub/MX-hub/mx-outputs/audit/2026-05-26/mx.allabout.network/mx-allabout-network-report.md - 34 placeholder leaks at lines: 80(116), 80([X]), 80([X]), 80([X]), 80([X]), 80([X]), 80([X]), 80([X])…. Each one indicates an infill handler that did not match its template anchor, or a handler that returned empty for an expected field.
