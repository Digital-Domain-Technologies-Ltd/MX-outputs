...
- Accessibility: 13 distinct WCAG AA issue types (368 raw instances, 368 marked critical by Pa11y) - 356 of these instances trace to 65 recurring template patterns (single theme edit per pattern fixes all instances)
...
Facts (do not change any number, percentage, URL, page count, or name):
- Pages audited: 6
- Performance: 2305ms avg (Excellent)
- Accessibility: 89/100 (Excellent)
- SEO: 92/100 (Excellent)
- Accessibility issues: 13 distinct WCAG codes across 368 raw instances (356 instances trace to 65 template patterns)
-->
...
- Accessibility: 89/100 (13 distinct WCAG codes, 368 raw instances) - 356 of these instances trace to 65 template-level patterns
- Security headers: 4/5 present (HTTPS, HSTS, CSP, X-Content-Type-Options); 0 of 6 audited URLs carry all five
- Structured Data Quality: 65/100
- Consistency: 62%
-->
...
- Accessibility: 89/100 (Excellent) - 368 issues - 356 trace to 65 template pattern(s)
- SEO: 92/100 (Excellent)
- Security headers: 4/5 present (HTTPS, HSTS, CSP, X-Content-Type-Options); 0 of 6 audited URLs carry all five
- Heading quality: 88/100
- Pipeline Survivability: 78/100
- Served HTML: 79/100, Rendered HTML: n/a/100
- Performance: 2305ms average load time
...
- Variant clusters found:
  - Canonical: https://www.dkd.de/de; variants also present: https://www.dkd.de/de/
...
| Full Optimization | Catalogue Visibility, Discovery Readiness, Semantic Structure, MX Stack Completeness, Structured Data, Performance, Security headers, and optional enhancements | Full machine readiness: every agent, search engine, and structured-data consumer can read, trust, and act on the site |
