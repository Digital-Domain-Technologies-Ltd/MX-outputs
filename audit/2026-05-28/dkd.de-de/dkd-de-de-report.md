...
mx:
  ...
  canonicalUri: https://raw.githubusercontent.com/Digital-Domain-Technologies-Ltd/MX-outputs/main/audit/2026-05-28/dkd.de-de/dkd-de-de-report.md
...
We found no llms-full.txt on www.dkd.de, with the endpoint returning a 404 and no reference to it in the sitemap or the homepage head. We recommend adding an llms-full.txt file to provide machines with a full-text index of your content; we recommend treating this as a conditional next step once that depth is established.
...
Across the 7 pages we audited, structured data shows a strong foundation. Adding recommended properties and increasing type diversity on these pages gives machines more to work with.
...
1. **Address Priority 1 findings**: We recommend resolving the 520 WCAG 2.1 AA accessibility issues identified (regulatory exposure)
