...
description: "Findings sidecar for the Sibotacademy audit on 2026-06-10. Records every gate finding (error, warning, info) raised during the run, for human sign-off and for a machine to consider, decide on, and action before delivery."
...
|---|------|----------|---------|----------|
| 1 | timeout-fierce-critic | subprocess-timeout | Subprocess timeout (fierce-critic) | 2026-06-10T10:26:51Z |
| 2 | check-report-coherence.js | placeholder-leak | 1 unresolved placeholder token(s) leaked into the final report: 0 | 2026-06-10T10:32:14Z |
| 3 | check-report-coherence.js | construction-path-leak | construction-path-leak at /Users/tomcranstoun/Documents/GitHub/MX-hub/mx-outputs/audit/2026-06-10/sibotacademy.pl-en/sibotacademy-pl-en-report.md:28 | 2026-06-10T10:32:14Z |
| 4 | check-report-coherence.js | construction-path-leak | construction-path-leak at /Users/tomcranstoun/Documents/GitHub/MX-hub/mx-outputs/audit/2026-06-10/sibotacademy.pl-en/sibotacademy-pl-en-report.md:30 | 2026-06-10T10:32:14Z |
| 5 | check-report-coherence.js | marker-section-contradiction | Cross-Page Consistency reports Canonical URL 64% but consistency_analysis says 70% (7/10) | 2026-06-10T10:32:14Z |
| 6 | check-report-coherence.js | marker-section-contradiction | Cross-Page Consistency reports Skip link 64% but consistency_analysis says 70% (7/10) | 2026-06-10T10:32:14Z |
| 7 | check-report-coherence.js | marker-section-contradiction | Cross-Page Consistency reports Open Graph tags 91% but consistency_analysis says 100% (10/10) | 2026-06-10T10:32:14Z |
...
**2. check-report-coherence.js - 1 unresolved placeholder token(s) leaked into the final report: 0**

/Users/tomcranstoun/Documents/GitHub/MX-hub/mx-outputs/audit/2026-06-10/sibotacademy.pl-en/sibotacademy-pl-en-report.md — 1 placeholder leaks at lines: 833([0]). Each one indicates an infill handler that did not match its template anchor, or a handler that returned empty for an expected field.
...
**3. check-report-coherence.js - construction-path-leak at /Users/tomcranstoun/Documents/GitHub/MX-hub/mx-outputs/audit/2026-06-10/sibotacademy.pl-en/sibotacademy-pl-en-report.md:28**
...
**4. check-report-coherence.js - construction-path-leak at /Users/tomcranstoun/Documents/GitHub/MX-hub/mx-outputs/audit/2026-06-10/sibotacademy.pl-en/sibotacademy-pl-en-report.md:30**

Internal script path "scripts/audit-*.js" leaked.

Line 30: command: "node scripts/audit-pipeline.js --gates mx-outputs/audit/2026-06-10/sibotacademy.pl-en/sibotacademy-pl-en-report.md"

Suggested next steps:

- Rewrite the offending sentence to remove the leaked phrase.

**5. check-report-coherence.js - Cross-Page Consistency reports Canonical URL 64% but consistency_analysis says 70% (7/10)**

/Users/tomcranstoun/Documents/GitHub/MX-hub/mx-outputs/audit/2026-06-10/sibotacademy.pl-en/sibotacademy-pl-en-report.md — the Cross-Page Consistency table's percentage for Canonical URL does not match the underlying consistency_analysis.json record. The two values are computed from the same source data and should agree.
...
**6. check-report-coherence.js - Cross-Page Consistency reports Skip link 64% but consistency_analysis says 70% (7/10)**

/Users/tomcranstoun/Documents/GitHub/MX-hub/mx-outputs/audit/2026-06-10/sibotacademy.pl-en/sibotacademy-pl-en-report.md — the Cross-Page Consistency table's percentage for Skip link does not match the underlying consistency_analysis.json record. The two values are computed from the same source data and should agree.

Suggested next steps:

- Trace the Cross-Page Consistency printer in infill-report.js — verify it reads coverage from consistency_analysis.patterns directly.

**7. check-report-coherence.js - Cross-Page Consistency reports Open Graph tags 91% but consistency_analysis says 100% (10/10)**
...
| # | Gate | Category | Finding | Recorded |
|---|------|----------|---------|----------|
| 1 | voice-consistency | mixed-voice-sections | Mixed-voice section(s) remain after auto-repair: 1 | 2026-06-10T10:24:50Z |
| 2 | sample-vs-total-scope | scope-mis-statements | Scope mis-statements remain after auto-repair: 6 | 2026-06-10T10:24:50Z |
| 3 | check-report-coherence.js | inventory-mismatch | Image inventory: 4 images in formats not named in prose | 2026-06-10T10:32:14Z |
...
| # | Gate | Category | Finding | Recorded |
|---|------|----------|---------|----------|
| 1 | prose-lint | prose-quality | Prose linter flagged 86 style finding(s) for review | 2026-06-10T10:32:15Z |
...

{
  ...
  "findings": [
    ...
    },
    {
      ...
      "match": "evidence (2x)",
      "snippet": "The companion .deterministic.json file carries the deterministic evidence chain (gate verdicts, CSV checks, render steps, probe results) and serves EAA Directiv",
      "rephrase_hint": "Distinctive content word \"evidence\" appears 2 times in one sentence (writing-style.md §6 \"No distinctive content wo
