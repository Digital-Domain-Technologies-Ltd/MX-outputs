...
| 3 | clear-results | COLLECT | 0.0s | pass |  |
| 4 | ai-usage-check | COLLECT | 0.2s | pass |  |
| 5 | sitemap-discovery | COLLECT | 1.6s | warn | no sitemap found |
| 6 | sitemap-anomaly | COLLECT | 0.1s | pass |  |
| 7 | crawler | COLLECT | 14.7s | pass |  |
| 8 | url-discovery | COLLECT | 0.7s | pass |  |
| 9 | pdf-topup | COLLECT | 0.1s | pass |  |
| 10 | pdf-sample | COLLECT | 0.1s | pass |  |
| 11 | error-page-test | COLLECT | 0.5s | pass |  |
| 12 | agent-access-test | COLLECT | 23.0s | pass |  |
| 13 | served-rendered-gap | COLLECT | 0.1s | pass |  |
| 14 | slowest-page-probe | COLLECT | 0.5s | warn |  |
| 15 | ab-test-detection | COLLECT | 0.1s | pass | Google Optimize detected |
| 16 | framework-detection | COLLECT | 0.1s | pass | 3 framework(s) detected: Next.js (medium), Tailwind CSS (medium), Vercel (low) |
| 17 | freshness-expiry-detection | COLLECT | 0.1s | pass | no content-declared expires across 12 page(s) |
| 18 | provenance-gap-deterministic | COLLECT | 0.3s | pass |  |
...
1. agent-access-test - 23.0s
2. crawler - 14.7s
3. sitemap-discovery - 1.6s

---

## REPORT - 2026-06-09 18:58:01
...
| 1 | template-voice-check | REPORT | 0.1s | pass |  |
| 2 | infill-pass1 | REPORT | 0.5s | pass |  |
| 3 | rewrite-pass2 | REPORT | 3m 57s | pass |  |
| 4 | engagement-table-regen | REPORT | 0.1s | pass |  |
| 5 | audit-delta-inject | REPORT | 0.1s | pass |  |
| 6 | error-section-regen | REPORT | 0.1s | pass |  |
...
| Metric | Value |
|--------|-------|
| Total elapsed | 3m 58s |
| Steps completed | 6 |
| Steps skipped | 0 |

**Slowest steps:**

1. rewrite-pass2 - 3m 57s
2. infill-pass1 - 0.5s
3. template-voice-check - 0.1s

---

## GATES - 2026-06-09 19:06:45
...
| 18 | unified-repair | GATES | 3m 19s | warn |  |
| 19 | gate-4b | GATES | 0.1s | pass |  |
| 20 | gate-4c | GATES | 0.7s | pass |  |
| 21 | gate-prose-lint | GATES | 0.1s | warn | 85 finding(s) |
| 22 | gate-4d-provenance | GATES | 1m 36s | pass |  |
| 23 | gate-4e-action-findings | GATES | 0.3s | pass |  |
| 24 | gate-5-pdf | GATES | 7.6s | pass | mx-outputs/audit/2026-06-09/sibotacademy.pl-en/sibotacademy-pl-en-report.pdf |
...
| Metric | Value |
|--------|-------|
| Total elapsed | 8m 44s |
| Steps completed | 24 |
| Steps skipped | 0 |

**Slowest steps:**

1. unified-repair - 3m 19s
2. gate-4-llm-judgment - 1m 54s
3. gate-3-fierce-critic - 1m 43s

---

## REPORT - 2026-06-09 19:17:14
...
| 1 | template-voice-check | REPORT | 0.1s | pass |  |
| 2 | infill-pass1 | REPORT | 0.5s | pass |  |
| 3 | rewrite-pass2 | REPORT | 3m 55s | pass |  |
| 4 | engagement-table-regen | REPORT | 0.1s | pass |  |
| 5 | audit-delta-inject | REPORT | 0.1s | pass |  |
| 6 | error-section-regen | REPORT | 0.1s | pass |  |
...
1. rewrite-pass2 - 3m 55s
2. infill-pass1 - 0.5s
3. template-voice-check - 0.1s

---

## REPORT - 2026-06-09 19:27:56
...
| 1 | template-voice-check | REPORT | 0.1s | pass |  |
| 2 | infill-pass1 | REPORT | 0.5s | pass |  |
| 3 | rewrite-pass2 | REPORT | 3m 56s | pass |  |
| 4 | engagement-table-regen | REPORT | 0.1s | pass |  |
| 5 | audit-delta-inject | REPORT | 0.1s | pass |  |
| 6 | error-section-regen | REPORT | 0.1s | pass |  |
...
| Metric | Value |
|--------|-------|
| Total elapsed | 3m 57s |
| Steps completed | 6 |
| Steps skipped | 0 |

**Slowest steps:**

1. rewrite-pass2 - 3m 56s
2. infill-pass1 - 0.5s
3. template-voice-check - 0.1s

---

## GATES - 2026-06-09 19:35:22
...
| 14 | gate-1 | GATES | 0.1s | pass |  |
| 15 | gate-2 | GATES | 0.2s | pass |  |
| 16 | gate-3-fierce-critic | GATES | 1m 40s | pass |  |
| 17 | gate-4-llm-judgment | GATES | 1m 49s | pass |  |
| 18 | unified-repair | GATES | 1m 54s | pass |  |
| 19 | gate-4b | GATES | 0.1s | pass |  |
| 20 | gate-4c | GATES | 0.7s | pass |  |
| 21 | gate-prose-lint | GATES | 0.1s | warn | 84 finding(s) |
| 22 | gate-4d-provenance | GATES | 1m 50s | pass |  |
| 23 | gate-4e-action-findings | GATES | 0.3s | pass |  |
| 24 | gate-5-pdf | GATES | 7.4s | pass | mx-outputs/audit/2026-06-09/sibotacademy.pl-en/sibotacademy-pl-en-report.pdf |
...
| Metric | Value |
|--------|-------|
| Total elapsed | 7m 25s |
| Steps completed | 23 |
| Steps skipped | 1 |

**Slowest steps:**

1. unified-repair - 1m 54s
2. gate-4d-provenance - 1m 50s
3. gate-4-llm-judgment - 1m 49s

---

## GATES - 2026-06-09 20:03:07
...
| 14 | gate-1 | GATES | 0.1s | pass |  |
| 15 | gate-2 | GATES | 0.2s | pass |  |
| 16 | gate-3-fierce-critic | GATES | 1m 51s | pass |  |
| 17 | gate-4-llm-judgment | GATES | 1m 22s | pass |  |
| 18 | unified-repair | GATES | 1m 18s | pass |  |
| 19 | gate-4b | GATES | 0.1s | pass |  |
| 20 | gate-4c | GATES | 0.7s | pass |  |
| 21 | gate-prose-lint | GATES | 0.1s | warn | 85 finding(s) |
| 22 | gate-4d-provenance | GATES | 2m 3s | pass |  |
| 23 | gate-4e-action-findings | GATES | 0.3s | pass |  |
| 24 | gate-5-pdf | GATES | 10.9s | pass | mx-outputs/audit/2026-06-09/sibotacademy.pl-en/sibotacademy-pl-en-report.pdf |
...
| Metric | Value |
|--------|-------|
| Total elapsed | 6m 49s |
| Steps completed | 23 |
| Steps skipped | 1 |

**Slowest steps:**

1. gate-4d-provenance - 2m 3s
2. gate-3-fierce-critic - 1m 51s
3. gate-4-llm-judgment - 1m 22s

---

## REPORT - 2026-06-10 06:36:04
...
| 1 | template-voice-check | REPORT | 0.1s | pass |  |
| 2 | infill-pass1 | REPORT | 0.5s | pass |  |
| 3 | rewrite-pass2 | REPORT | 4m 46s | pass |  |
| 4 | engagement-table-regen | REPORT | 0.1s | pass |  |
| 5 | audit-delta-inject | REPORT | 0.1s | pass |  |
| 6 | error-section-regen | REPORT | 0.1s | pass |  |
...
| Metric | Value |
|--------|-------|
| Total elapsed | 4m 47s |
| Steps completed | 6 |
| Steps skipped | 0 |

**Slowest steps:**

1. rewrite-pass2 - 4m 46s
2. infill-pass1 - 0.5s
3. template-voice-check - 0.1s

---

## REPORT - 2026-06-10 06:53:56
...
| 1 | template-voice-check | REPORT | 0.1s | pass |  |
| 2 | infill-pass1 | REPORT | 0.5s | pass |  |
| 3 | rewrite-pass2 | REPORT | 4m 39s | pass |  |
| 4 | engagement-table-regen | REPORT | 0.1s | pass |  |
| 5 | audit-delta-inject | REPORT | 0.1s | pass |  |
| 6 | error-section-regen | REPORT | 0.1s | pass |  |
...
| Metric | Value |
|--------|-------|
| Total elapsed | 4m 39s |
| Steps completed | 6 |
| Steps skipped | 0 |

**Slowest steps:**

1. rewrite-pass2 - 4m 39s
2. infill-pass1 - 0.5s
3. template-voice-check - 0.1s

---

## GATES - 2026-06-10 07:02:25
...
| 14 | gate-1 | GATES | 0.1s | pass |  |
| 15 | gate-2 | GATES | 0.2s | pass |  |
| 16 | gate-3-fierce-critic | GATES | 1m 21s | pass |  |
| 17 | gate-4-llm-judgment | GATES | 1m 29s | pass |  |
| 18 | unified-repair | GATES | 3m 17s | warn |  |
| 19 | gate-4b | GATES | 0.1s | pass |  |
| 20 | gate-4c | GATES | 0.7s | pass |  |
| 21 | gate-prose-lint | GATES | 0.1s | warn | 85 finding(s) |
| 22 | gate-4d-provenance | GATES | 2m 10s | pass |  |
| 23 | gate-4e-action-findings | GATES | 0.2s | pass |  |
| 24 | gate-5-pdf | GATES | 7.5s | pass | mx-outputs/audit/2026-06-09/sibotacademy.pl-en/sibotacademy-pl-en-report.pdf |
...
| Metric | Value |
|--------|-------|
| Total elapsed | 8m 29s |
| Steps completed | 23 |
| Steps skipped | 1 |

**Slowest steps:**

1. unified-repair - 3m 17s
2. gate-4d-provenance - 2m 10s
3. gate-4-llm-judgment - 1m 29s
