...
|--------|--------------|----------------|--------------------|
| Served HTML  | 11/100 (high)   | 61 bare divs (81% of containers, depth 8)   | `div.w-num` (48), `div.wrap` (36), `div.safety-it` (20), `div.two-col` (19), `div` (17) |
...
**Worst page (served):** [/en/worlds](https://sibotacademy.pl/en/worlds)\
