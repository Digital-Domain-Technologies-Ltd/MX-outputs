...
auditCommand: "node scripts/audit-pipeline.js https://www.whiteroseclub.com --pages 10"
...
| Machine Processing Speed | **171** ms/page | `#################-` Machine-Ready |
...
Whiteroseclub runs on Shopify. Across the audited set, Whiteroseclub scores 94/100 for accessibility and 77/100 for SEO, with solid page performance (97/100) - a strong baseline for both human visitors and machine readers.
...
We found that across the audited set, brand-name parity, canonical URL duplicates, meta description length, and cross-page entity spread are inconsistent; aligning brand names, ensuring unique canonical URLs, trimming meta descriptions to recommended length, and standardising entity references across pages will resolve these inconsistencies.
...
Hosting provider: unknown. Platform: **Shopify**. 2 findings stand out: assets remain hosted on Wix's CDN (static.wixstatic.com), Wix's CDN (docs.wixstatic.com) from a previous platform. If those accounts close, those assets will return 404s.
...
|----------|---------------|------|
| Former CMS assets | Wix CDN (static.wixstatic.com) | Assets from a previous platform - link rot risk if account lapses |
| Former CMS assets | Wix CDN (docs.wixstatic.com) | Assets from a previous platform - link rot risk if account lapses |

- **Former Wix assets at static.wixstatic.com**: if the Wix account lapses, these assets will return 404s. Migrate them to the primary host or a permanent storage location.
- **Former Wix assets at docs.wixstatic.com**: if the Wix account lapses, these assets will return 404s. Migrate them to the primary host or a permanent storage location.
...
We checked all 5 PDF document(s) on the site. The documents pass the structural tagging test but some images lack alternative text. Under the European Accessibility Act (in force 28 June 2025) and the UK Equality Act 2010, inaccessible service documents carry complaint and enforcement risk. Accessibility exposure: **high**.
...
|----------|-----------|-----------------|----------|----------|-------------|------|
| ....com/ugd/b823dd_cd1783306265430287ef1ecb5acf453e.pdf | Document | Pass | Declared | Missing | No forms | Medium |
| ....com/ugd/2eb026_83e714b630a94b5482bfd6dbab76b949.pdf | Document | Fail | Declared | No images | No forms | High |
| ...iles/ugd/b823dd_cd1783306265430287ef1ecb5acf453e.pdf | Document | Pass | Declared | Missing | No forms | Medium |
| ...iles/ugd/b823dd_cd566789c4b7461e944e21105a228816.pdf | Document | Pass | Declared | No images | No forms | Low |
| ...iles/ugd/b823dd_f3b66e8a04e147078edf3cde1cf875b7.pdf | Document | Fail | Declared | No images | No forms | High |

**What to do:** Fix before the next content update. Unlabelled form fields are a service barrier under the Equality Act. Use Adobe Acrobat Pro (Forms panel > Tooltip) or re-export from the source tool with accessibility features enabled.
...
*Showing the top 5 of 7 pages by duplication level. Full per-page scores are in `www-whiteroseclub-com-content-uniqueness.csv`.*
...
| Full Implementation | Commerce Visibility, Structured Data, Semantic Structure, Discovery Readiness, MX Stack Completeness, Heading Quality, Security headers, and optional enhancements | Full machine readiness: every agent, search engine, and structured-data consumer can read, trust, and act on the site |
...
| Accessibility | 94/100 | Rendered | Checked in a rendered browser environment |
...
| Agent Readability | 36/100 | Rendered | A noticeable share of pages have structure issues that make agent reading slower or less accurate. |
...
- **/visitorregistration**
  SEO 73 · A11y 75 · Backend 60 · Served 89 · Rendered 95
- **/supporting-documents**
  SEO 64 · A11y 100 · Backend 60 · Served 98 · Rendered 100
- **/new2naturism3**
  SEO 77 · A11y 100 · Backend 60 · Served 90 · Rendered 97
- **/members-data-update**
  SEO 74 · A11y 80 · Backend 60 · Served 59 · Rendered 66
- **/visitor-s-fees**
  SEO 73 · A11y 100 · Backend 70 · Served 100 · Rendered 100
- **/archive-photos**
  SEO 76 · A11y 95 · Backend 60 · Served 98 · Rendered 100
- **/ (nav)**
  SEO 88 · A11y 100 · Backend 90 · Served 100 · Rendered 100
- **/visiting-us-booking**
  SEO 81 · A11y 95 · Backend 60 · Served 96 · Rendered 100
- **/home**
  SEO 79 · A11y 100 · Backend 60 · Served 91 · Rendered 98
- **/events-and-gallery**
  SEO 82 · A11y 95 · Backend 60 · Served 99 · Rendered 100
...
JPEG and PNG account for 98% of the 53 images (38 and 14 files respectively). None use WebP, the modern format that typically reduces file size by 25-35% over PNG or JPEG with no visible quality loss.
