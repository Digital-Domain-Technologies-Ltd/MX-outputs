...
- Site: Enhancely (www.enhancely.ai)
- Pages audited: 12 of 51 in sitemap - sample run
- Date: 2026-06-12
- Scores: SEO 87/100 | Accessibility 100/100 | Discovery Readiness 40/100 | Structured Data 88/100
- Scope: 12 pages audited - write "across the audited set", NEVER "site-wide"
- Schema types already present (do NOT recommend adding these): Question (66), Answer (66), ListItem (61), BreadcrumbList (24), Organization (24), Person (22), WebPage (12), WebSite (12), FAQPage (12), BlogPosting (7), Article (5), ImageObject (4)
...
- Next-level action: Score thresholds for Governed are met (MSC 68, SDQ 88, DR 40), but no MX-namespaced governance metadata was detected on the audited pages. Add MX governance fields (mx:status, mx:contentType, mx:audience, canonicalUri, and provenance markers) to at least one published page to unlock Governed level. Without those fields a machine can discover the page but lacks the governance context for accurate comprehension.
...
- SEO (content pages only): 87/100
- Accessibility: 100/100 (0 distinct WCAG codes, 0 raw instances)
- Security headers: 3/5 present (HTTPS, X-Frame-Options, X-Content-Type-Options); 0 of 12 audited URLs carry all five
- Structured Data Quality: 88/100
- Consistency: 52%
-->
...
FACTS (do not change any number, percentage, URL, page count, or name):
- Schema.org types detected: 12 type(s) present
...
| Organization | 12 | 100% | 100% | ImageObject |
| Person | 11 | 100% | 100% | - |
| WebPage | 12 | 100% | 100% | BreadcrumbList, Organization, WebSite, Person |
| WebSite | 12 | 100% | 25% | Organization |
| FAQPage | 12 | 100% | 100% | - |
| BlogPosting | 7 | 100% | 100% | Person, Organization, WebPage, ImageObject |
| Article | 5 | 93% | 100% | Organization, WebPage, Person, ImageObject |
...
| [/blog/why-your-developer-online-documentation-is-failing-ai-coding-assistants-and-how-knowledge-graphs-fix-it](https://www.enhancely.ai/blog/why-your-developer-online-documentation-is-failing-ai-coding-assistants-and-how-knowledge-graphs-fix-it) | - | - | - | 2 third-party links | complete |
...
| [/blog/e-e-a-t-for-the-ai-era-how-chatgpt-co-recognize-your-brand-as-a-trustworthy-source](https://www.enhancely.ai/blog/e-e-a-t-for-the-ai-era-how-chatgpt-co-recognize-your-brand-as-a-trustworthy-source) | - | - | - | 2 third-party links | complete |
...
- Served score: 48, band high (worst page: [/blog/webmcp-and-nlweb-two-new-standards-are-turning-websites-into-ai-interfaces](https://www.enhancely.ai/blog/webmcp-and-nlweb-two-new-standards-are-turning-websites-into-ai-interfaces))
- Rendered score: 48, band high (worst page: [/blog/webmcp-and-nlweb-two-new-standards-are-turning-websites-into-ai-interfaces](https://www.enhancely.ai/blog/webmcp-and-nlweb-two-new-standards-are-turning-websites-into-ai-interfaces))
- Bare divs (served): 93 of 205 (45%)
- Bare divs (rendered): 98 of 216 (45%)
- Deepest bare chain: served 5, rendered 5
- Top bare selectors (served): `div.k-block.k-block__text` (215), `div.max-w-[1440px].mx-auto` (71), `div.faq-a.text-[0.92rem]` (51), `div.flyout-panel` (36), `div.flyout-panel-inner` (36)
- Top bare selectors (rendered): `div.k-block.k-block__text` (215), `div.mobile-sub` (72), `div.max-w-[1440px].mx-auto` (71), `div.faq-a.text-[0.92rem]` (51), `div.flyout-panel` (36)
...
WRITE:
2-3 sentences summarising the audit findings for Enhancely (https://www.enhancely.ai). Always refer to the site by its domain (https://www.enhancely.ai), never by the consultancy name. The highest-scoring dimension is AI Suitability at 100/100 - open with this as a strength. Open with the dimension that scored HIGHEST on the scorecard as a genuine STRENGTH. "Leads" means highest score, not highest priority finding. A dimension scoring 10/100 is never "the strongest" - it is an opportunity. High priority ≠ high score; do not confuse the two. Then name 1-2 lowest-scoring dimensions as the key OPPORTUNITIES. Close with an invitation to act.

FACTS:
- Scores: AI Suitability: 100/100; Accessibility: 100/100; SEO: 87/100; Structured Data: 88/100; Discovery Readiness: 40/100
