...
- Pages audited: 12 of 3391 in sitemap - sample run
- Date: 2026-06-12
...
Facts (do not change any number, percentage, URL, page count, or name):
- Pages audited: 12
- Performance: 3429ms avg (Could Be Better)
...
FACTS (do not change any number, percentage, URL, page count, or name):
- Schema.org types detected: 2 type(s) present
...
Stage 2 (Citation) is the weakest link in the agent journey. Because each stage depends on the previous one, this gap affects all downstream stages. Addressing Schema.org: WebSite, Organization, WebSite (100% required properties) is the highest-priority improvement.
...
- Served score: 34, band high (worst page: [/products/personalization/ai-suggestions/](https://www.contentful.com/products/personalization/ai-suggestions/))
- Rendered score: 34, band high (worst page: [/products/personalization/](https://www.contentful.com/products/personalization/))
- Bare divs (served): 209 of 405 (52%)
- Bare divs (rendered): 290 of 566 (51%)
- Deepest bare chain: served 7, rendered 7
- Top bare selectors (served): `div` (206), `div.grid-helper-col.col-span-1` (132), `div.tooltip_root__EulUk` (95), `div.button_markup_root__sACGr.button_markup_secondary__F_qxS` (61), `div.round-icon.round_icon_container__Jmlwp` (57)
...
- Open by naming what was found and what was not: "Ninetailed, Google Optimize, Optimizely, Visual Website Optimizer (VWO), Kameleoon, Dynamic Yield, Unbounce Smart Traffic (personalisation) is present on https://www.contentful.com/products/ai-actions/, https://www.contentful.com/products/studio/, https://www.contentful.com/contact/sales/, https://www.contentful.com/products/platform/, https://www.contentful.com/products/personalization/ and 7 more, but every visit returned the same content during this audit."
...
| Full Implementation | Commerce Visibility, Semantic Structure, Discovery Readiness, Structured Data, MX Stack Completeness, Heading Quality, Performance, Security headers, and optional enhancements | Full machine readiness: every agent, search engine, and structured-data consumer can read, trust, and act on the site |
...
WRITE:
2-3 sentences summarising the audit findings for Www Contentful (https://www.contentful.com). Always refer to the site by its domain (https://www.contentful.com), never by the consultancy name. The highest-scoring dimension is AI Suitability at 99/100 - open with this as a strength. Open with the dimension that scored HIGHEST on the scorecard as a genuine STRENGTH. "Leads" means highest score, not highest priority finding. A dimension scoring 10/100 is never "the strongest" - it is an opportunity. High priority ≠ high score; do not confuse the two. Then name 1-2 lowest-scoring dimensions as the key OPPORTUNITIES. Close with an invitation to act.

FACTS:
- Scores: AI Suitability: 99/100; Accessibility: 77/100; SEO: 94/100; Structured Data: 61/100; Discovery Readiness: 39/100
