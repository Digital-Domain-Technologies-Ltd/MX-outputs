...
- Security headers: 2/5 present (HTTPS, HSTS); 0 of 1 audited URL carry all five
- Structured Data Quality: 0/100
- Consistency: 20%
-->
...
WRITE:
2 sentences for a client-facing audit report. Flag that the site's internal links (no sitemap is published; the crawl seeded from link discovery) contains multiple URL variants for the same canonical page (trailing-slash and/or hash-fragment forms). Explain that AI agents and LLM pipelines that do not normalise URLs will treat these as separate pages - wasting token budget and potentially producing contradictory or inflated findings. State the fix exactly as the FACTS line gives it. This is a site-wide artefact finding about the internal link structure; describe it as a property of the internal links and do NOT mention a sitemap as the source, and do NOT use per-page sampling language such as "on each page" or "across the audited set".

FACTS:
- Crawled URLs before deduplication: 12
- Unique canonical pages after normalisation: 1
- Inflation factor: 12×
- Variant clusters found:
  - Canonical: https://atmors.netlify.app; variants also present: https://atmors.netlify.app/#top, https://atmors.netlify.app/#about, https://atmors.netlify.app/#services, https://atmors.netlify.app/#team, https://atmors.netlify.app/#clients, https://atmors.netlify.app/#impact, https://atmors.netlify.app/#about, https://atmors.netlify.app/#services, https://atmors.netlify.app/#team, https://atmors.netlify.app/#clients, https://atmors.netlify.app/#impact
...
- Fix: add a <link rel="canonical"> tag to each affected URL; when a sitemap.xml is published, list one canonical form per resource
-->
