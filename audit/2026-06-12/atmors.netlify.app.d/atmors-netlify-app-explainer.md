...
|---|------|-------|----------|---------|-------|
| 1 | template-voice-check | REPORT | 0.1s | pass |  |
| 2 | infill-pass1 | REPORT | 0.4s | pass |  |
| 3 | rewrite-pass2 | REPORT | 2m 38s | pass |  |
| 4 | engagement-table-regen | REPORT | 0.1s | pass |  |
| 5 | audit-delta-inject | REPORT | 0.1s | pass |  |
| 6 | error-section-regen | REPORT | 0.1s | pass |  |
...
| Metric | Value |
|--------|-------|
| Total elapsed | 2m 39s |
| Steps completed | 6 |
| Steps skipped | 0 |

**Slowest steps:**

1. rewrite-pass2 - 2m 38s
2. infill-pass1 - 0.4s
3. template-voice-check - 0.1s

---

## GATES - 2026-06-12 15:40:36
...
| 17 | gate-4-llm-judgment | GATES | 1m 46s | warn |  |
| 18 | unified-repair | GATES | 1m 44s | pass |  |
| 19 | gate-4b | GATES | 0.1s | pass |  |
| 20 | gate-4c | GATES | 0.8s | warn | 1 finding(s) |
| 21 | gate-prose-lint | GATES | 0.2s | pass |  |
| 22 | gate-4d-provenance | GATES | 1m 37s | pass |  |
| 23 | gate-4e-action-findings | GATES | 0.3s | pass |  |
| 24 | gate-5-pdf | GATES | 6.3s | pass | mx-outputs/audit/2026-06-12/atmors.netlify.app/atmors-netlify-app-report.pdf |
...
| Metric | Value |
|--------|-------|
| Total elapsed | 6m 27s |
| Steps completed | 24 |
| Steps skipped | 0 |

**Slowest steps:**

1. gate-4-llm-judgment - 1m 46s
2. unified-repair - 1m 44s
3. gate-4d-provenance - 1m 37s

---

## REPORT - 2026-06-12 16:21:21
...
| 1 | template-voice-check | REPORT | 0.1s | pass |  |
| 2 | infill-pass1 | REPORT | 0.5s | pass |  |
| 3 | rewrite-pass2 | REPORT | 4m 5s | pass |  |
| 4 | engagement-table-regen | REPORT | 0.1s | pass |  |
| 5 | audit-delta-inject | REPORT | 0.1s | pass |  |
| 6 | error-section-regen | REPORT | 0.1s | pass |  |
...
1. rewrite-pass2 - 4m 5s
2. infill-pass1 - 0.5s
3. template-voice-check - 0.1s

---

## GATES - 2026-06-12 16:27:46
...
| 23 | gate-4e-action-findings | GATES | 0.3s | pass |  |
| 24 | gate-5-pdf | GATES | 6.8s | pass | mx-outputs/audit/2026-06-12/atmors.netlify.app.d/atmors-netlify-app-report.pdf |
...
| Metric | Value |
|--------|-------|
| Total elapsed | 6m 25s |
| Steps completed | 24 |
| Steps skipped | 0 |

**Slowest steps:**

1. unified-repair - 1m 44s
2. gate-4d-provenance - 1m 39s
3. gate-3-fierce-critic - 1m 29s

---

## COLLECT - 2026-06-13 00:23:11
...
| 4 | clear-results | COLLECT | 0.0s | pass |  |
| 5 | ai-usage-check | COLLECT | 0.2s | pass |  |
| 6 | sitemap-discovery | COLLECT | 1.4s | warn | no sitemap found |
| 7 | sitemap-anomaly | COLLECT | 0.1s | pass |  |
| 8 | crawler | COLLECT | 3.7s | pass |  |
| 9 | url-discovery | COLLECT | 0.8s | pass |  |
| 10 | pdf-topup | COLLECT | 0.1s | pass |  |
| 11 | pdf-sample | COLLECT | 0.1s | pass |  |
| 12 | error-page-test | COLLECT | 0.6s | pass |  |
| 13 | agent-access-test | COLLECT | 1.0s | pass |  |
| 14 | served-rendered-gap | COLLECT | 0.1s | pass |  |
| 15 | slowest-page-probe | COLLECT | 1.2s | pass |  |
| 16 | ab-test-detection | COLLECT | 0.1s | pass | no A/B test or personalisation vendors detected |
| 17 | framework-detection | COLLECT | 0.1s | pass | 2 framework(s) detected: Bootstrap (low), Netlify (low) |
| 18 | freshness-expiry-detection | COLLECT | 0.1s | pass | no content-declared expires across 3 page(s) |
| 19 | a11y-tree-check | COLLECT | 0.2s | pass | 0 page(s), 0 cluster(s) (0 template-level), score 100/100 |
...
1. crawler - 3.7s
2. sitemap-discovery - 1.4s
3. slowest-page-probe - 1.2s

---

## GATES - 2026-06-13 08:25:29
...
| 14 | gate-1 | GATES | 0.1s | pass |  |
| 15 | gate-2 | GATES | 0.2s | pass |  |
| 16 | gate-3-fierce-critic | GATES | 1m 17s | pass |  |
| 17 | gate-4-llm-judgment | GATES | 1m 39s | pass |  |
| 18 | unified-repair | GATES | 53.1s | pass |  |
| 19 | gate-4b | GATES | 0.1s | pass |  |
| 20 | gate-4c | GATES | 0.8s | warn | 1 finding(s) |
| 21 | gate-prose-lint | GATES | 0.1s | pass |  |
| 22 | gate-4d-provenance | GATES | 2m 4s | pass |  |
| 23 | gate-4e-action-findings | GATES | 0.3s | pass |  |
| 24 | gate-5-pdf | GATES | 10.9s | pass | mx-outputs/audit/2026-06-12/atmors.netlify.app.d/atmors-netlify-app-report.pdf |
...
1. gate-4d-provenance - 2m 4s
2. gate-4-llm-judgment - 1m 39s
3. gate-3-fierce-critic - 1m 17s
