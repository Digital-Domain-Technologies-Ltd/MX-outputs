---
title: "Stackoptic: Website Analysis & Machine Readiness"
author: "Tom Cranstoun"
created: "2026-06-12"
modified: "2026-06-12"
client: "Stackoptic"
clientSlug: "stackoptic-com"
clientUrl: "https://stackoptic.com"
reportId: "stackoptic-com-WEB-AUDIT-20260612"
reportType: "executive-sales-report"
auditTool: "web-audit-suite"
auditDate: "2026-06-12"
auditCommand: "node scripts/audit-pipeline.js https://stackoptic.com --pages 10 --date 2026-06-12 --client stackoptic-com"
description: "Executive audit report reviewing accessibility, performance, SEO, structured data, and AI agent compatibility for Stackoptic"
...
mx:
  ...
  canonicalUri: https://raw.githubusercontent.com/Digital-Domain-Technologies-Ltd/MX-outputs/main/audit/2026-06-12/stackoptic.com/stackoptic-com-report.md
  maintainer: info@cognovamx.com
  stability: stable
  partOf: mx-audit
  purpose: "Executive machine-readiness audit for Stackoptic covering accessibility, performance, SEO, structured data, and AI agent compatibility."
  x-mx-contextProvides: ["web audit findings for Stackoptic", "WCAG accessibility assessment", "AI agent compatibility scores", "SEO and structured data analysis", "machine readiness recommendations"]
  ...
  runbook: "Executive audit report for Stackoptic. Focus on the highest-leverage MX opportunities surfaced by the audit. To re-run the audit from scratch (re-crawl and re-analyse), use the command in the top-level auditCommand field. Regenerate the tagged PDF with 'node scripts/audit-pipeline.js --gates mx-outputs/audit/2026-06-12/stackoptic.com/stackoptic-com-report.md', which validates the report then renders it through scripts/bin/mx.pdf.sh."
  generate:
    command: "node scripts/audit-pipeline.js --gates mx-outputs/audit/2026-06-12/stackoptic.com/stackoptic-com-report.md"
    script: "scripts/bin/mx.pdf.sh"
    format: "pdf"
    output: "mx-outputs/audit/2026-06-12/stackoptic.com/stackoptic-com-report.pdf"
    description: "Generate PDF audit report for Stackoptic"
  ...
  x-mx-provenance:
    sidecar: "stackoptic-com-report.provenance.ai.json"
    frameworks: [EU-AI-Act, UK-ICO-AI-guidance, NIST-AI-RMF, Colorado-AI-Act]
    companion: "stackoptic-com-report.provenance.deterministic.json"
...
**Date:** 12 June 2026\
**Report ID:** stackoptic-com-WEB-AUDIT-20260612
...
- **Origin server is slow for an agent fetch** (-5): origin verdict slow, slowest median 314ms
- **Bare-div nesting (div soup) across most pages** (-8): 4 of 7 pages are heavy with bare-div nesting

Your site runs on **Netlify** (detected from multiple platform signals).

Across the audited set, your site delivers clear, engaging content built on solid SEO foundations. The 86/100 score demonstrates that search engines can easily discover and index your pages, giving visitors fast access to relevant information.

The headline opportunity we want to draw attention to is accessibility compliance. We identified three distinct WCAG AA issue types affecting 34 instances; addressing each pattern will resolve many critical errors at once. Following this, the next natural step for machine experience is to elevate your MX readiness from Level 1 Discoverable to Level 2 Governed by adding full MX governance fields-mx:status, mx:contentType, mx:audience, canonicalUri and provenance markers-to provide machines with the structured context they need for accurate comprehension. Raising MSC above 60 and Discovery Readiness above 40 will move your site into the governed band.

\clearpage

<!-- AUDIT-DELTA:START -->
## Change Since Our 4 June 2026 Audit

We last audited stackoptic.com on 4 June 2026. The table compares that audit with the current one across the headline measures. Some scores improved and others slipped since that audit; the table shows each change.

| Measure | 4 June 2026 | 12 June 2026 | Change |
|---------|------:|------:|:-------|
| Performance | 85 | 35 | -50 (declined) |
| Accessibility | 86 | 93 | +7 (improved) |
| SEO | 89 | 86 | -3 (declined) |
| Machine Suitability | 75 | 100 | +25 (improved) |
| WCAG AA issues | 78 | 34 | -44 (improved) |
| Pages audited | 7 | 6 | -1 |
...
We present the Human Experience subtable, which shows that across the audited set your pages deliver an excellent overall experience, with accessibility at 93/100 and SEO at 86/100, though page load times averaging 3085 ms indicate room for improvement.
...
Across the audited set, machines can discover and parse your content-supported by a Structured Data Quality of 89/100 and Pipeline Survivability of 92/100-but they lack governance context, as shown by an MX Readiness Level of 1 (Discoverable), a Discovery Readiness score of 38/100, and an MX Stack Completeness of 69/100.
...
|-----------|-------|--------|-------|----------|
| Discovery Readiness | 38/100 | Could Be Better | C | C (median) |
| Structured Data Quality | 89/100 | Excellent | A | B (median) |
| MX Stack Completeness | 69/100 | Good | B | B (median) |
...
**Evidence:** MX Stack Completeness 69/100 | Structured Data Quality 89/100 | Discovery Readiness 38/100 | Consistency 60%
...
Across the audited set, your pages exhibit a strong foundations in SEO (86/100), accessibility (93/100 with only three WCAG codes across 34 instances), security headers (5/5 on every URL), and structured-data quality (89/100). These strengths provide the groundwork for focused enhancements that will elevate performance even further.
...
| Structured Data | 89 | Excellent - JSON-LD on every page with valid Schema.org vocabulary |
| Heading Quality | 88 | Excellent - single H1 on every page |
| Consistency | 60% | 60% - same metadata patterns across every page |
...
- Structured Data Quality of 89/100 (Good schema): the schema is valid, required properties are complete, and the vocabulary is in good order.
- JSON-LD is present in the served HTML of every page: every agent that fetches the raw HTML gets the structured data.
- Body content ratio averages 32%: pages are content-heavy, not overhead-heavy, which helps agents reach real prose inside a cheap fetch.
...
The audit identified 7 findings on the audited set, ordered by regulatory exposure first and then by priority within each category.
...
| 3 | No Bypass Mechanism for Repeated Blocks, WCAG 2.4.1 | Compliance Risk | Medium | Low | sighted keyboard users may miss or misread affected content |
| 4 | Heading Hierarchy Skips Levels | Compliance Risk | Medium | Low | screen-reader and machine outline-builders may misread the page structure |
| 5 | Semantic Structure (Naked Containers) 27/100 | Compliance Risk | Medium | Medium | machines lose structural context and infer page regions by position |
| 6 | Slow Origin Response | Cross-cutting | Medium | High | first-time visitors and cold-cache agents wait for the first byte |
...
**Finding:** This element has insufficient contrast at this conformance level. Expected a contrast ratio of at least 4.5:1, but text in this element has a contrast ratio of 3.59:1. Recommendation: change text colour to #fefeff. This pattern appears 26 time(s) across the audited set, affecting low-vision users.
...
**Finding:** Img element is the only content of the link, but is missing alt text. The alt text should describe the purpose of the link. This pattern appears 7 time(s) across the audited set, affecting screen reader users.
...
**Priority 3: No Bypass Mechanism for Repeated Blocks, WCAG 2.4.1**

**Bucket:** Compliance Risk

**Finding:** Iframe element requires a non-empty title attribute that identifies the frame. This pattern appears 1 time(s) across the audited set, affecting sighted keyboard users.
...
**Priority 4: Heading Hierarchy Skips Levels**
...
**Priority 5: Semantic Structure (Naked Containers) 27/100**

**Bucket:** Compliance Risk

**Finding:** Rendered semantic-structure score 27/100: containers carry no role, ARIA landmark, or descriptive class, so machines fall back on positional inference to determine meaning. The worst page ([the home page](https://stackoptic.com/)) carries 206 bare divs of 325.
...
**Priority 6: Slow Origin Response**

**Bucket:** Cross-cutting

**Finding:** The slowest audited page took 11670 ms on a first-time (cold-cache) fetch, well above the healthy origin-response band, so a first-time visitor or an agent arriving on a cold cache waits noticeably for the first byte (returning visitors with a warm cache are served in about 314 ms).
...
**Finding:** 48 Schema.org property gap(s) on the audited set across WebSite, Offer: required or recommended properties are missing, so machines extract these entities less reliably.
...
- **sameAs**: adds authoritative external identifiers to Person and Organisation entities, enabling machines to disambiguate profiles; add to all Person and Organisation JSON-LD blocks.  
- **SpeakableSpecification**: lets voice assistants surface key excerpts from BlogPosting pages by defining CSS selectors for headline and first paragraph; include in each blog post’s JSON-LD.  
- **potentialAction**: exposes contact capabilities on Organisation entities, allowing machines to discover how to reach the organisation via ContactPoint; add to all Organisation JSON-LD blocks.
...
| Check | Result |
|-------|--------|
| URL probed | https://stackoptic.com |
| HTTP status | 200 |
...
| Internal navigation links | 23 links to same-site pages |
...
Across the 7 pages we checked, 25 distinct issue patterns reduce what reaches the tree. 2 of these repeat across pages with the same structure, which marks them as template-level: one change in the shared component clears the finding everywhere it appears.

**Element exposed as an image with no accessible name** (WCAG 2.1 1.1.1)

An element declares role="img" (or is an inline SVG acting as content) with no accessible name. The tree exposes an image-shaped hole: consumers know something pictorial is there and nothing else. Repeats on 3 of 7 pages with the same structure (a template-level pattern).
...
An element declares role="img" (or is an inline SVG acting as content) with no accessible name. The tree exposes an image-shaped hole: consumers know something pictorial is there and nothing else. Seen on 2 pages, for example `/about`.
...
An input relies on placeholder text as its only label. The placeholder vanishes the moment the visitor types, is not reliably exposed as the accessible name, and disappears entirely in text projections of the page. Seen on `/`.
...
The full set, one row per pattern with every affected page counted, is recorded in the `stackoptic-com-accessibility-tree.csv` sidecar alongside this report.
...
**Slowest.** The slowest page is `https://stackoptic.com/blog`. A first-time visitor sees the cold-cache cost: the crawler recorded 11670 ms on its initial fetch. **First-visit verdict: Slow: investigate origin**. Three fresh re-probes that followed returned 269ms, 314ms, 317ms, giving a returning-visitor median of **314 ms**. **Returning-visitor verdict: Healthy**.

**Median-load control.** The median-load control page is `https://stackoptic.com/technologies`. A first-time visitor sees the cold-cache cost: the crawler recorded 1756 ms on its initial fetch. **First-visit verdict: Acceptable but elevated**. Three fresh re-probes that followed returned 1575ms, 472ms, 311ms, giving a returning-visitor median of **472 ms**. **Returning-visitor verdict: Healthy**.
...
Disallow: /sign-up
Disallow: /account
Disallow: /dashboard-x7k9m
Disallow: /*__clerk*
Disallow: /*__clerk_handshake*
Disallow: /*__clerk_db_jwt*
```

*Showing the first 10 lines of `robots.txt`; the full 85-line file is preserved alongside this report as `stackoptic-com-robots-txt.txt`.*

The robots.txt declares 63 disallow paths; all other paths are open to crawlers and machines. It announces the sitemap, so a machine reading the file can find the URL index directly.
...
|-----------|---------|------------|
| `<loc>` URLs | 34026 entries | Present |
...
The sitemap declares 34026 URLs and grades Complete. Lastmod dates vary across entries, which tells machines which pages changed and when.

This was a full crawl: the audit reached every page it could discover, and 3 of them are absent from the sitemap (which lists 34026). The unlisted pages: `/pricing`, `/sign-up`, `/terms`. The full set is recorded in the `stackoptic-com-pages-not-in-sitemap.csv` sidecar alongside this report. Adding them to the sitemap lets search engines and machines discover all content.

We discovered that the sitemap lists multiple URL variants for the same canonical resource, such as trailing-slash and hash-fragment forms, which means machines will treat them as distinct pages. To prevent token waste and contradictory findings, we recommend publishing a single canonical URL per resource in sitemap.xml and adding a <link rel="canonical"> tag to each affected URL.
...
The llms-full.txt file exists but is served as `text/plain`. This is the same transport problem as the llms.txt case: Common Crawl will not treat a non-HTML response as indexable, so the file will not reach LLM training data. Intercept the path at the edge, wrap the raw text in a minimal HTML document with the content inside `<pre>`, and return `Content-Type: text/html`.
...
|--------------|-------|------------|---------------|------------------------------------------|
| Person | 6 | 100% | 100% | - |
| BlogPosting | 1 | 100% | 100% | Person |
| Organisation | 6 | 100% | 100% | PostalAddress, Place, Person, ImageObject |
| ContactPoint | 6 | 100% | 100% | - |
| PostalAddress | 6 | 100% | 100% | - |
| SoftwareApplication | 6 | 100% | 100% | Offer, Organisation |
| WebSite | 6 | 100% | 25% | SearchAction, Organisation |
| Question | 2 | 100% | 100% | Answer |
| Answer | 2 | 100% | 100% | - |
| Offer | 6 | 100% | 0% | - |
| ImageObject | 6 | 100% | 100% | - |
| WebPage | 6 | 100% | 100% | WebSite, SoftwareApplication, Website, Software |
| Place | 6 | 100% | 100% | PostalAddress |
| SearchAction | 6 | 100% | 100% | EntryPoint |
| EntryPoint | 6 | 100% | 100% | - |
| ListItem | 3 | 100% | 100% | - |
| HowToStep | 1 | 100% | 100% | - |
| BreadcrumbList | 3 | 100% | 100% | - |
| FAQPage | 2 | 100% | 100% | - |
| VideoObject | 1 | 100% | 100% | Organisation |
| HowTo | 1 | 100% | 100% | HowToTool |
| HowToTool | 1 | 100% | 100% | - |
| ContactPage | 1 | 100% | 100% | Website, Organisation |
| CollectionPage | 1 | 100% | 100% | Organisation |
| Blog | 1 | 100% | 100% | Organisation |

**Structured Data Quality:** 89/100\
**Coverage:** 6 pages with JSON-LD out of 6 total (100%)\
**Unique types:** 25

Across the 6 pages we audited, structured data is strong. Machines extract entity data from these pages reliably and the typed vocabulary survives the read. Whether machines use the content for attribution or recommendation is their decision -- governance metadata (see the MX Readiness Level section) gives them the structured context to do so accurately.
...
| Entity richness | 9 | 15 | Entities are described with enough properties to be useful |
| Cross-entity references | 12 | 15 | Entities reference each other (nested types and @id links) |
| Linked-data signals | 10 | 10 | Linked-data properties present (sameAs, mainEntityOfPage, isPartOf, about, mentions) |
...
We identified 48 specific Schema.org property gaps. Each row names a single missing property on a single entity with a short note on why it matters to machines.

The full per-entity list is delivered alongside this report as a sidecar CSV: [`stackoptic-com-structured-data-findings.csv`](stackoptic-com-structured-data-findings.csv). The 48 rows describe individual Schema.org property gaps on specific entities; most of them share a small number of underlying patterns, shown below ranked by instance count.
...
|------|----------|----------|----------:|------:|----------------|
| WebSite | recommended | image | 6 | 6 | Site has no logo / hero image declared in structured data |
| WebSite | recommended | author | 6 | 6 | Site has no top-level author/owner declared |
| Offer | recommended | availability | 6 | 6 | Offer has no in-stock signal; agents cannot tell if buyable |
...
| WebSite | recommended | datePublished | 6 | 6 | No site-level publish date for crawler context |
...
|------|----------|-----------|--------------------------|------------------------|----------------------|
| [/](https://stackoptic.com/) | - | - | - | 3 third-party links | missing: author |
| [/about](https://stackoptic.com/about) | - | - | - | 3 third-party links | missing: author |
| [/](https://stackoptic.com/) | - | - | - | 3 third-party links | missing: author |
...
**To reach the next level:** To reach Level 3: wrap the JSON-LD blocks in a single @graph document; mainEntityOfPage on the primary entity. Apply the graph structure to commerce entities.
...
|-------|-------------------|-------------|-------|---------------------------------------------------|
| 1 | Discovery | Pass | 95 | Crawlable with semantic HTML |
| 2 | Citation | Partial | 59 | Schema.org: Organisation, PostalAddress, Place (100% required properties) |
...
Stage 2 (Citation) is the bottleneck in the agent journey. Because each stage builds on the one before it, the stages after it cannot improve until this one does. It is the highest-priority place to start; the stage's key metric is Schema.org: Organisation, PostalAddress, Place (100% required properties).
...
- **Truncation Risk** - Pass · 6/6
  - *Means:* Every page is well under the 250 KB hard ceiling at which some server-side agents stop reading, and main content sits within the 50-100 KB offset windows. The largest page is 169 KB ([/blog](https://stackoptic.com/blog)).
  - *Data:* Largest page: 169 KB ([/blog](https://stackoptic.com/blog)). Thresholds: 250 KB hard ceiling; 50/75/100 KB content-offset windows.
- **SPA Shell** - Pass · 6/6
...
- **Boilerplate Burial** - Pass · 6/6
  ...
  - *Data:* Highest boilerplate-to-content ratio: 0.14. Threshold: < 10 (and < 80 KB of inline head bytes).
...
- **HTTP Content Negotiation (Vary)** - Pass · 6/6
...
- **Body Content Ratio** - Pass · N/A
  - *Means:* Actual prose content averages 32% of served bytes, well above the 30% threshold. Pages are content-heavy, not overhead-heavy.
  - *Data:* Average: 32%. Threshold: 30%.
- **Inline Tag Bloat** - Fail · 6/6
  ...
  - *Data:* 52 element(s) > 500 bytes. Largest single-page inline CSS block: 220 B. Largest single-page inline JS block: 99245 B. See stackoptic-com-pipeline-inline-tag-bloat-pages.csv (6 pages).
...
We found that every audited page shows Inline Tag Bloat, a resilience issue that can make it harder for machines to parse and render content quickly. Because of this bloat, agents may experience slower load times or misinterpret the structure of the page. The most impactful fix is to consolidate or move inline styles and scripts into external files, which will streamline parsing and improve machine efficiency.
...
|--------|--------------|----------------|--------------------|
| Served and rendered | 27/100 (high) | 206 bare divs (63% of containers, depth 7) | `div` (62), `div.flex.items-center` (44), `div.w-10.h-10` (30), `div.mt-auto.pt-4` (24), `div.container.mx-auto` (21) |

**Worst page (served and rendered are identical):** [the home page](https://stackoptic.com/)

On the worst-page (https://stackoptic.com/), 206 of 325 elements are plain `<div>` tags, a 63 % bare-div ratio that forces machines to fall back on positional inference rather than semantic structure.  
The soup is structural, with a deepest chain of seven nested bare `<div>`s, indicating the use of an untyped component framework or late-stage JavaScript injection that nests many generic containers.  
A low-cost first step is to wrap obvious landmarks-header, nav, main, footer, aside-and assign meaningful class names to remaining elements so the bare-div ratio drops without altering layout.
...
- **`/contact`**: HTTPS Yes · HSTS Yes · CSP Yes · X-Frame Yes · X-Content-Type Yes
- **`/technologies`**: HTTPS Yes · HSTS Yes · CSP Yes · X-Frame Yes · X-Content-Type Yes
...
- **`/pricing`**: HTTPS Yes · HSTS Yes · CSP Yes · X-Frame Yes · X-Content-Type Yes
...
| Lighthouse heading compliance | 50% | 3 |

**Overall Consistency:** 60%

Some pages in the 6-page sample are missing metadata patterns that others carry. Machines hitting different pages get different quality data. The Missing Pages column shows where to focus on the sampled pages.

## Content Consistency

Content consistency examines how metadata and structured data align across the audited pages, influencing how machines interpret and surface your content. We evaluated title tags, meta descriptions, canonical URLs, brand identifiers, and entity values to detect any divergence that could confuse crawlers or dilute search relevance. This assessment helps ensure a unified signal for both users and machines.
...
| Check                            | Result | Notes                    |
|----------------------------------|--------|--------------------------|
| Brand-name parity | Pass | Brand name appears consistently across all 6 audited pages |
...
We found 11 identical inline fragment(s) repeated across multiple pages, totalling 17 KB redundant bytes. Extracting these to external CSS or JS files would reduce page weight, improve cacheability, and simplify maintenance.
...
|------|-------------------:|-------------------:|------------------------------------------------------------------|
| css | 200 | 7 | html { background: #09090b; color: #f4f4f5; }           body |
| js | 97 | 7 | (function() {                 document.documentElement.class |
| js | 374 | 4 | self.__next_f.push([1,"1:HL[\"/_next/static/media/bb3ef058b7 |
| js | 72 | 4 | (self.__next_f=self.__next_f\|\|[]).push([0]);self.__next_f.pu |
| js | 34 | 4 | self.__next_f.push([1,"6:null\n"]) |
| js | 8111 | 2 | self.__next_f.push([1,"b:[\"$\",\"$Lf\",null,{\"signInUrl\": |
| js | 1801 | 2 | self.__next_f.push([1,"5:I[12846,[],\"\"]\n8:I[4707,[],\"\"] |
| js | 1709 | 2 | self.__next_f.push([1,"{\"@context\":\"https://schema.org\", |
| js | 1648 | 2 | (self.__next_s=self.__next_s\|\|[]).push([0,{"type":"applicati |
| js | 871 | 2 | self.__next_f.push([1,"3:[\"$\",\"script\",null,{\"type\":\" |

*Showing the top 10 of 11 duplicate fragments by occurrence count. The full inventory (every fragment with its hash and the page URLs that carry it) is preserved alongside this report as `stackoptic-com-inline-code-duplicates.csv`.*
...
We observe that across major markets, accessibility law now converges on ISO 14289-1 (PDF/UA) as the technical baseline for PDFs; the European Accessibility Act is a clear example of this global alignment.  
We also recognise that without proper tagging, a PDF remains invisible to machines-search crawlers and AI systems cannot extract text or structure from a scanned or image-based file, whereas a tagged PDF with a full structure tree becomes machine-readable just like semantic HTML.
...
1. **Address Priority 1 findings**: address the 34 WCAG 2.1 AA accessibility issues identified (regulatory exposure)
...
Across the audited set of six pages on https://stackoptic.com, we found AI Suitability at a perfect 100/100, showing your content is fully ready for advanced machine processing.  
Key opportunities lie in Discovery Readiness (38/100) and Structured Data (89/100), where richer metadata can improve machine discoverability while human visitors are already served well.  
Acting on these findings will improve machine comprehension and maximise the reach of your content.
...
| MX Stack Completeness | 69/100 | Good |
| Structured Data Quality | 89/100 | Excellent |
| Commerce Visibility | 20/100 | Needs Improvement |
| Discovery Readiness | 38/100 | Could Be Better |
| Heading Quality | 88/100 | Excellent |
| Agent Readability | 61/100 | Good |
| Pipeline Survivability | 92/100 | Excellent |
| Cross-Page Consistency | 60% | Good |
...
- **`/about`**: SEO 84 · A11y 85 · Back 100 · Served 100 · Rendered 100
- **`/contact`**: SEO 82 · A11y 90 · Back 100 · Served 100 · Rendered 100
- **`/technologies (nav)`**: SEO 81 · A11y 90 · Back 100 · Served 100 · Rendered 100
- **`/blog`**: SEO 89 · A11y 90 · Back 100 · Served 100 · Rendered 100
- **`/pricing`**: SEO 86 · A11y 100 · Back 100 · Served 100 · Rendered 100

Pages marked (nav) are navigational: they route visitors to content rather than containing it, and are excluded from the SEO content average. Content-pages SEO average: 84/100.
...
Per page, internal links range from 10 to 42, averaging 18 across 6 pages. That is typical (benchmark median 20 per page).
...
| Link class | Count |
| --- | ---: |
| Same-host internal links (all pages) | 110 |
...
We reviewed 35 images across the audited set: 11 WebP and 24 SVG. 24 of 35 (68.6%) carry alt text, leaving 11 without it. Each missing alt attribute is a place where a screen-reader user or a machine reading the page gets no description of what the image shows.

On loading strategy, 24 images are marked `loading="lazy"` and 11 `loading="eager"`, so every image on the audited pages declares its fetch behaviour explicitly rather than leaving the browser to guess.
...
**Scope:** 6 pages examined | Platform: Netlify | Frameworks: **Next.js** (low confidence) - JS framework; **Tailwind CSS** - CSS framework; **WooCommerce** (low confidence) - CMS plugin; **Cloudflare CDN** (medium confidence) - CDN / delivery; **Netlify** (low confidence) - CDN / delivery | Analysis method: Hybrid (automated + manual verification) | robots.txt: Present (124 directives)
