...
description: "Findings sidecar for the Stackoptic audit on 2026-06-12. Records every gate finding (error, warning, info) raised during the run, for human sign-off and for a machine to consider, decide on, and action before delivery."
...
|---|------|----------|---------|----------|
| 1 | check-report-coherence.js | placeholder-leak | 1 unresolved placeholder token(s) leaked into the final report: 0 | 2026-06-13T09:08:55Z |
| 2 | check-report-coherence.js | marker-section-contradiction | Cross-Page Consistency reports Canonical URL 83% but consistency_analysis says 100% (5/5) | 2026-06-13T09:08:55Z |
| 3 | check-report-coherence.js | marker-section-contradiction | Cross-Page Consistency reports Open Graph tags 83% but consistency_analysis says 100% (5/5) | 2026-06-13T09:08:55Z |
| 4 | check-report-coherence.js | marker-section-contradiction | Cross-Page Consistency reports Twitter Card tags 83% but consistency_analysis says 100% (5/5) | 2026-06-13T09:08:55Z |
| 5 | check-prose-score-binding.js | internal-contradiction | Prose score for SEO contradicts the scorecard at /Users/tomcranstoun/Documents/GitHub/MX-hub/mx-outputs/audit/2026-06-12/stackoptic.com/stackoptic-com-report.md:1163 | 2026-06-13T09:08:56Z |
...
/Users/tomcranstoun/Documents/GitHub/MX-hub/mx-outputs/audit/2026-06-12/stackoptic.com/stackoptic-com-report.md — 1 placeholder leaks at lines: 1071([0]). Each one indicates an infill handler that did not match its template anchor, or a handler that returned empty for an expected field.
...
**2. check-report-coherence.js - Cross-Page Consistency reports Canonical URL 83% but consistency_analysis says 100% (5/5)**

/Users/tomcranstoun/Documents/GitHub/MX-hub/mx-outputs/audit/2026-06-12/stackoptic.com/stackoptic-com-report.md — the Cross-Page Consistency table's percentage for Canonical URL does not match the underlying consistency_analysis.json record. The two values are computed from the same source data and should agree.
...
**3. check-report-coherence.js - Cross-Page Consistency reports Open Graph tags 83% but consistency_analysis says 100% (5/5)**
...
**4. check-report-coherence.js - Cross-Page Consistency reports Twitter Card tags 83% but consistency_analysis says 100% (5/5)**

/Users/tomcranstoun/Documents/GitHub/MX-hub/mx-outputs/audit/2026-06-12/stackoptic.com/stackoptic-com-report.md — the Cross-Page Consistency table's percentage for Twitter Card tags does not match the underlying consistency_analysis.json record. The two values are computed from the same source data and should agree.

Suggested next steps:

- Trace the Cross-Page Consistency printer in infill-report.js — verify it reads coverage from consistency_analysis.patterns directly.

**5. check-prose-score-binding.js - Prose score for SEO contradicts the scorecard at /Users/tomcranstoun/Documents/GitHub/MX-hub/mx-outputs/audit/2026-06-12/stackoptic.com/stackoptic-com-report.md:1163**

Narrative says SEO scored 84/100; the scorecard table says 86/100. The rewrite pass likely bound another dimension's number.

Line 1163: Content-pages SEO average: 84/100.

Suggested next steps:

- Correct the narrative to 86/100, or re-run the repair pass - the scorecard table is the canonical value.
...
| # | Gate | Category | Finding | Recorded |
|---|------|----------|---------|----------|
| 1 | cross-section-consistency | cross-section-scope-mix | Line 882: scope-mixing prose | 2026-06-13T09:08:56Z |

<details open><summary>Warning detail (1)</summary>

**1. cross-section-consistency - Line 882: scope-mixing prose**
...
| # | Gate | Category | Finding | Recorded |
|---|------|----------|---------|----------|
| 1 | prose-lint | prose-quality | Prose linter flagged 76 style finding(s) for review | 2026-06-13T09:08:56Z |

<details open><summary>Info detail (1)</summary>

**1. prose-lint - Prose linter flagged 76 style finding(s) for review**
