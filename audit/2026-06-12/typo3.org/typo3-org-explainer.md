...
URL: https://typo3.org  Date: 2026-06-12  Run ID: 3pqjb88s7s

## COLLECT - 2026-06-13 01:57:16
...
| 6 | sitemap-discovery | COLLECT | 0.5s | pass | https://typo3.org/sitemap.xml |
| 7 | sitemap-anomaly | COLLECT | 0.6s | pass |  |
| 8 | crawler | COLLECT | 5m 38s | pass |  |
...
| 13 | agent-access-test | COLLECT | 19.8s | pass |  |
...
| 19 | a11y-tree-check | COLLECT | 0.5s | pass | 12 page(s), 4 cluster(s) (3 template-level), score 66/100 |
| 20 | provenance-gap-deterministic | COLLECT | 0.3s | pass |  |
| 21 | provenance-gap-llm | COLLECT | 1m 33s | pass |  |
| 22 | audience-classify | COLLECT | 4.4s | pass |  |
...
3. provenance-gap-llm - 1m 33s

---

## REPORT - 2026-06-13 08:13:58
...
| 3 | rewrite-pass2 | REPORT | 2m 36s | pass |  |
...
| Metric | Value |
|--------|-------|
| Total elapsed | 2m 37s |
| Steps completed | 6 |
| Steps skipped | 0 |

**Slowest steps:**

1. rewrite-pass2 - 2m 36s
2. infill-pass1 - 0.5s
3. template-voice-check - 0.1s

---

## GATES - 2026-06-13 09:19:13
...
| 17 | gate-4-llm-judgment | GATES | 1m 38s | pass |  |
| 18 | unified-repair | GATES | 1m 11s | pass |  |
| 19 | gate-4b | GATES | 0.1s | pass |  |
| 20 | gate-4c | GATES | 0.8s | warn | 3 finding(s) |
...
| 24 | gate-5-pdf | GATES | 7.3s | pass | mx-outputs/audit/2026-06-12/typo3.org/typo3-org-report.pdf |
...
1. gate-3-fierce-critic - 1m 51s
2. gate-4-llm-judgment - 1m 38s
3. unified-repair - 1m 11s
