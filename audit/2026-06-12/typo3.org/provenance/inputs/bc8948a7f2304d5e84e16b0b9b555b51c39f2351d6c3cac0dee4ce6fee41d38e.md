...
- Pages audited: 12 of 75 in sitemap - sample run
- Date: 2026-06-12
- Scores: SEO 75/100 | Accessibility 100/100 | Discovery Readiness 25/100 | Structured Data 0/100
...
Facts (do not change any number, percentage, URL, page count, or name):
- Pages audited: 12
- Performance: 882ms avg (Excellent)
...
Facts (do not change any number, percentage, URL, page count, or name):
- Pages audited: 12
- SEO (all pages): 75/100
- SEO (content pages only): 74/100
- Accessibility: 100/100 (0 distinct WCAG codes, 0 raw instances)
- Security headers: 2/5 present (HTTPS, X-Content-Type-Options); 0 of 12 audited URLs carry all five
- Structured Data Quality: 0/100
- Consistency: 43%
-->
...
- Pages audited: 12
- Pipeline Survivability score: 96
...
- Served score: 20, band high (worst page: [/association](https://typo3.org/association))
- Rendered score: 21, band high (worst page: [/association](https://typo3.org/association))
- Bare divs (served): 216 of 288 (75%)
- Bare divs (rendered): 228 of 310 (74%)
- Deepest bare chain: served 7, rendered 7
- Top bare selectors (served): `div.frame-group-container` (195), `div.frame-group-inner` (183), `div.frame-container.frame-container-default` (183), `div.frame-inner` (183), `div.contentcontainer-column` (88)
- Top bare selectors (rendered): `div.frame-group-container` (195), `div.frame-group-inner` (183), `div.frame-container.frame-container-default` (183), `div.frame-inner` (183), `div.contentcontainer-column` (88)
...
WRITE:
2-3 sentences summarising the audit findings for Typo3 (https://typo3.org). Always refer to the site by its domain (https://typo3.org), never by the consultancy name. The highest-scoring dimension is Accessibility at 100/100 - open with this as a strength. Open with the dimension that scored HIGHEST on the scorecard as a genuine STRENGTH. "Leads" means highest score, not highest priority finding. A dimension scoring 10/100 is never "the strongest" - it is an opportunity. High priority ≠ high score; do not confuse the two. Then name 1-2 lowest-scoring dimensions as the key OPPORTUNITIES. Close with an invitation to act.

FACTS:
- Scores: AI Suitability: 91/100; Accessibility: 100/100; SEO: 75/100; Structured Data: 0/100; Discovery Readiness: 25/100
