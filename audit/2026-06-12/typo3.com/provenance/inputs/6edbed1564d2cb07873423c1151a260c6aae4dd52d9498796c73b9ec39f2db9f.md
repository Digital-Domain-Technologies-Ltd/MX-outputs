...
- Site: Typo3 (typo3.com)
- Pages audited: 11 of 284 in sitemap - sample run
- Date: 2026-06-12
- Scores: SEO 82/100 | Accessibility 100/100 | Discovery Readiness 25/100 | Structured Data 0/100
...
- Schema Maturity: No structured data detected on the audited set (Schema Maturity does not apply until at least one Schema.org JSON-LD block is present).
...
Facts (do not change any number, percentage, URL, page count, or name):
- Pages audited: 11
- SEO (all pages): 82/100
- SEO (content pages only): 82/100
- Accessibility: 100/100 (0 distinct WCAG codes, 0 raw instances)
- Security headers: 2/5 present (HTTPS, X-Content-Type-Options); 0 of 11 audited URLs carry all five
- Structured Data Quality: 0/100
- Consistency: 43%
-->
...
FACTS (do not change any number, percentage, URL, page count, or name):
- Schema.org types detected: none (no JSON-LD present)
...
- Served score: 22, band high (worst page: [the home page](https://typo3.com/))
- Rendered score: 23, band high (worst page: [the home page](https://typo3.com/))
- Bare divs (served): 227 of 318 (71%)
- Bare divs (rendered): 239 of 340 (70%)
- Deepest bare chain: served 7, rendered 7
- Top bare selectors (served): `div.frame-group-container` (85), `div.frame-group-inner` (85), `div.frame-container.frame-container-default` (85), `div.frame-inner` (85), `div.container` (48)
- Top bare selectors (rendered): `div.frame-group-container` (85), `div.frame-group-inner` (85), `div.frame-container.frame-container-default` (85), `div.frame-inner` (85), `div.container` (48)
...
| Full Implementation | Commerce Visibility, Structured Data, Semantic Structure, Discovery Readiness, MX Stack Completeness, Security headers, and optional enhancements | Full machine readiness: every agent, search engine, and structured-data consumer can read, trust, and act on the site |
...
WRITE:
2-3 sentences summarising the audit findings for Typo3 (https://typo3.com). Always refer to the site by its domain (https://typo3.com), never by the consultancy name. The highest-scoring dimension is Accessibility at 100/100 - open with this as a strength. Open with the dimension that scored HIGHEST on the scorecard as a genuine STRENGTH. "Leads" means highest score, not highest priority finding. A dimension scoring 10/100 is never "the strongest" - it is an opportunity. High priority ≠ high score; do not confuse the two. Then name 1-2 lowest-scoring dimensions as the key OPPORTUNITIES. Close with an invitation to act.

FACTS:
- Scores: AI Suitability: 91/100; Accessibility: 100/100; SEO: 82/100; Structured Data: 0/100; Discovery Readiness: 25/100
