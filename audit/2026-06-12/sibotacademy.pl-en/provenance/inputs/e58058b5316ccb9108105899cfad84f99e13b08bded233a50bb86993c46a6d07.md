...
- Site: Sibotacademy (sibotacademy.pl)
- Pages audited: 11 of 22 in sitemap - sample run
- Date: 2026-06-12
- Scores: SEO 87/100 | Accessibility 95/100 | Discovery Readiness 32/100 | Structured Data 52/100
- Scope: 11 pages audited - write "across the audited set", NEVER "site-wide"
- Schema types already present (do NOT recommend adding these): Organization (9), WebSite (8), ContactPoint (4), Course (3), EducationalAudience (3), WebPage (3), AboutPage (1), Audience (1), ContactPage (1), OpeningHoursSpecification (1)
...
- Platform: Netlify
- Pages audited: 11
- SEO: 87/100 (Excellent)
- Accessibility: 1 distinct WCAG AA issue type (35 raw instances, 35 marked critical by Pa11y)
- AI Suitability (served): 81/100
- Structured Data Quality: 52/100
- Discovery Readiness: 32/100
...
Facts (do not change any number, percentage, URL, page count, or name):
- Pages audited: 11
- Performance: 896ms avg (Excellent)
- Accessibility: 95/100 (Excellent)
- SEO: 87/100 (Excellent)
- Accessibility issues: 1 distinct WCAG codes across 35 raw instances
-->
...
Facts (do not change any number, percentage, URL, page count, or name):
- Pages audited: 11
- SEO (all pages): 87/100
- SEO (content pages only): 86/100
- Accessibility: 95/100 (1 distinct WCAG codes, 35 raw instances)
- Security headers: 2/5 present (HTTPS, HSTS); 0 of 11 audited URLs carry all five
- Structured Data Quality: 52/100
- Consistency: 48%
-->
...
|--------------|-------|------------|---------------|------------------------------------------|
| Organization | 6 | 100% | 100% | ContactPoint |
| WebSite | 8 | 100% | 0% | - |
| ContactPoint | 4 | 100% | 100% | OpeningHoursSpecification |
| Course | 3 | 100% | 100% | Organization, EducationalAudience |
...
| 2 | Citation | Partial | 50 | Schema.org: Organization, ContactPoint, WebSite (100% required properties) |
...
- Checks flagged on any page: SPA Shell, Inline Tag Bloat
- Check with the most pages flagged: Inline Tag Bloat
- Pages affected by that check: 3 of 11
...
- Served score: 11, band high (worst page: [/en/worlds](https://sibotacademy.pl/en/worlds))
- Rendered score: 13, band high (worst page: [/en/worlds](https://sibotacademy.pl/en/worlds))
- Bare divs (served): 61 of 75 (81%)
- Bare divs (rendered): 64 of 82 (78%)
- Deepest bare chain: served 8, rendered 8
- Top bare selectors (served): `div.w-num` (48), `div.wrap` (36), `div.safety-it` (20), `div.two-col` (19), `div` (17)
- Top bare selectors (rendered): `div.w-num` (48), `div.wrap` (36), `div.safety-it` (20), `div.two-col` (19), `div` (17)
...
- Google Optimize (A/B testing) was detected on https://sibotacademy.pl/en/index.html, https://sibotacademy.pl/en/parent/sign-in, https://sibotacademy.pl/en/privacy-policy.html, https://sibotacademy.pl/en, https://sibotacademy.pl/en/forparents.html and 6 more
...
- Open by naming what was found and what was not: "Google Optimize (A/B testing) is present on https://sibotacademy.pl/en/index.html, https://sibotacademy.pl/en/parent/sign-in, https://sibotacademy.pl/en/privacy-policy.html, https://sibotacademy.pl/en, https://sibotacademy.pl/en/forparents.html and 6 more, but every visit returned the same content during this audit."
...
- Pages affected: https://sibotacademy.pl/en/index.html, https://sibotacademy.pl/en/parent/sign-in, https://sibotacademy.pl/en/privacy-policy.html, https://sibotacademy.pl/en, https://sibotacademy.pl/en/forparents.html and 6 more
...
| Full Implementation | Commerce Visibility, Semantic Structure, Discovery Readiness, Structured Data, MX Stack Completeness, Security headers, and optional enhancements | Full machine readiness: every agent, search engine, and structured-data consumer can read, trust, and act on the site |
...
WRITE:
2-3 sentences summarising the audit findings for Sibotacademy (https://sibotacademy.pl). Always refer to the site by its domain (https://sibotacademy.pl), never by the consultancy name. The highest-scoring dimension is SEO at 87/100 - open with this as a strength. Open with the dimension that scored HIGHEST on the scorecard as a genuine STRENGTH. "Leads" means highest score, not highest priority finding. A dimension scoring 10/100 is never "the strongest" - it is an opportunity. High priority ≠ high score; do not confuse the two. Then name 1-2 lowest-scoring dimensions as the key OPPORTUNITIES. Close with an invitation to act.

FACTS:
- Scores: AI Suitability: 81/100; Accessibility: 95/100; SEO: 87/100; Structured Data: 52/100; Discovery Readiness: 32/100
