---
title: "Sibotacademy: Website Analysis & Machine Readiness"
author: "Tom Cranstoun"
created: "2026-06-12"
modified: "2026-06-12"
client: "Sibotacademy"
clientSlug: "sibotacademy-pl-en"
clientUrl: "https://sibotacademy.pl"
reportId: "sibotacademy-pl-en-WEB-AUDIT-20260612"
reportType: "executive-sales-report"
auditTool: "web-audit-suite"
auditDate: "2026-06-12"
auditCommand: "node scripts/audit-pipeline.js https://sibotacademy.pl/en --pages 10 --date 2026-06-12 --client sibotacademy-pl-en"
description: "Executive audit report reviewing accessibility, performance, SEO, structured data, and AI agent compatibility for Sibotacademy"
tags: [web-audit, accessibility, wcag-aa, ai-agents, seo, performance, mx, executive-report]
performanceScore: 85
accessibilityScore: 95
seoScore: 87
llmSuitabilityScore: 81
totalIssues: 35
pagesAudited: 11
version: "1.0"
confidential: true
mx:
  ...
  canonicalUri: https://raw.githubusercontent.com/Digital-Domain-Technologies-Ltd/MX-outputs/main/audit/2026-06-12/sibotacademy.pl-en/sibotacademy-pl-en-report.md
  maintainer: info@cognovamx.com
  stability: stable
  partOf: mx-audit
  purpose: "Executive machine-readiness audit for Sibotacademy covering accessibility, performance, SEO, structured data, and AI agent compatibility."
  x-mx-contextProvides: ["web audit findings for Sibotacademy", "WCAG accessibility assessment", "AI agent compatibility scores", "SEO and structured data analysis", "machine readiness recommendations"]
  ...
  runbook: "Executive audit report for Sibotacademy. Focus on the highest-leverage MX opportunities surfaced by the audit. To re-run the audit from scratch (re-crawl and re-analyse), use the command in the top-level auditCommand field. Regenerate the tagged PDF with 'node scripts/audit-pipeline.js --gates mx-outputs/audit/2026-06-12/sibotacademy.pl-en/sibotacademy-pl-en-report.md', which validates the report then renders it through scripts/bin/mx.pdf.sh."
  generate:
    command: "node scripts/audit-pipeline.js --gates mx-outputs/audit/2026-06-12/sibotacademy.pl-en/sibotacademy-pl-en-report.md"
    script: "scripts/bin/mx.pdf.sh"
    format: "pdf"
    output: "mx-outputs/audit/2026-06-12/sibotacademy.pl-en/sibotacademy-pl-en-report.pdf"
    description: "Generate PDF audit report for Sibotacademy"
  ...
  x-mx-provenance:
    sidecar: "sibotacademy-pl-en-report.provenance.ai.json"
    frameworks: [EU-AI-Act, UK-ICO-AI-guidance, NIST-AI-RMF, Colorado-AI-Act]
    companion: "sibotacademy-pl-en-report.provenance.deterministic.json"
...
**Date:** 12 June 2026\
**Report ID:** sibotacademy-pl-en-WEB-AUDIT-20260612
...
| SEO | **87**/100 | `################--` |
| Served-HTML Structure | **81**/100 | `###############---` |
| MX Stack Completeness | **59**/100 | `###########-------` |
...
- **Audience had to be inferred (no machine-readable signal declared)** (-5): child audience, basis declaredInProse
- **Bare-div nesting (div soup) across most pages** (-8): 5 of 11 pages are heavy with bare-div nesting

Your site reads as aimed at a child audience, and your page text names an age band (`7-14`) that is not in machine-readable structured data, so an agent has to infer it; declaring `schema:typicalAgeRange` or `mx:intendedAgeRange` would let an agent read the band directly. Your site runs on **Netlify** (detected from multiple platform signals).

Your audience of aspiring developers finds the Sibotacademy platform welcoming and fast. The design is clean, with clear calls to action that guide learners through course listings and enrolment. Performance is excellent - across the audited set your pages load quickly, giving users a smooth experience, while SEO sits at 87/100, reinforcing discoverability for human visitors.

The headline opportunity we want to draw attention to is accessibility. Across the audited set there is one distinct WCAG AA issue type that appears in 35 elements; addressing it will lift compliance and improve usability for all visitors. Following this, the next natural step is to elevate machine readiness by adding full MX governance fields - mx:status, mx:contentType, mx:audience, canonicalUri, provenance markers - so machines have the structured context they need for accurate comprehension. Raising MSC above 60 and Discovery Readiness above 40 will move your site from Discoverable to Governed, unlocking richer machine interaction while keeping the strong foundations you already have.

\clearpage

<!-- AUDIT-DELTA:START -->
## Change Since Our 10 June 2026 Audit

We last audited sibotacademy.pl on 10 June 2026. The table compares that audit with the current one across the headline measures. Every headline score is unchanged from that audit, so the recommendations from that audit remain open.

| Measure | 10 June 2026 | 12 June 2026 | Change |
|---------|------:|------:|:-------|
| Performance | 85 | 85 | No change |
| Accessibility | 95 | 95 | No change |
| SEO | 87 | 87 | No change |
| Machine Suitability | 81 | 81 | No change |
| WCAG AA issues | 35 | 35 | No change |
...
Across the audited set, we find that the site delivers a strong experience for human visitors.
...
We found that across the audited set, machines can discover and parse your content with a Discovery Readiness of 32/100 and Structured Data Quality of 52/100, yet they lack governance context as reflected by an MX Readiness Level of 1 (Discoverable), while Pipeline Survivability remains high at 97/100 and MX Stack Completeness stands at 59/100.
...
|-----------|-------|--------|-------|----------|
| Discovery Readiness | 32/100 | Could Be Better | C | C (median) |
| Structured Data Quality | 52/100 | Good | B | B (median) |
| MX Stack Completeness | 59/100 | Good | B | B (median) |
| Pipeline Survivability | 97/100 | Excellent | A | A (median) |
...
**Evidence:** MX Stack Completeness 59/100 | Structured Data Quality 52/100 | Discovery Readiness 32/100 | Consistency 48%
...
We assess that this page is aimed at a child audience (stated in the page text as 7-14, but not declared in machine-readable metadata). We describe who the page appears to be for; we do not judge the content, and we do not block anything.

**Observed age assurance:** No age gate or age-verification step was observed on the page we classified.

**Consent and cookies on first visit:** No consent prompt was detected on first visit.

**Data-collection signals:** No form requests age or date of birth on the page we classified.

A page aimed at children attracts stronger duties in several frameworks: stronger protection of children's data, age-appropriate design across the development bands (0 to 5, 6 to 9, 10 to 12, 13 to 15, 16 to 17), restraint in profiling, and transparency about automated decisions in terms a child can understand. We report what we could and could not observe; we do not certify compliance.

Audiences with a reduced capacity to assess content carry stronger protection in several regulatory frameworks, including the EU AI Act Article 5 prohibition on exploiting age-related vulnerability. This is general context, not legal advice; requirements vary by jurisdiction, and you should consult qualified specialists for your situation.

Your page states the age band in its text, so the intent is clear to a human reader. An agent, though, has to parse it out of prose rather than read it directly. Declaring it in machine-readable metadata, a schema.org typicalAgeRange entry in your JSON-LD and mx:intendedAgeRange in MX metadata, lets a machine read the band with no parsing. The age-awareness signals an agent looks for were not observed either: where you operate an age-assurance step or a consent mechanism, make it machine-detectable. We carry these forward as Machine Readability findings; they make the signals legible to machines, and they are not compliance requirements.

<div class="page-break"></div>

## What's Working Well

Across the audited set your pages achieve high scores in SEO (87 / 100) and accessibility (95 / 100), laying a strong foundations for future enhancements. The table below details these strengths and sets the stage for targeted improvements.
...
|-----------|-------|------------|
| Performance | Excellent | Excellent - 896ms average load time |
| SEO (content pages) | 86 | Excellent - titles, meta descriptions, canonical URLs in place |
| Security | 2/5 | 2/5 headers present (CSP, X-Frame-Options, X-Content-Type-Options absent); 0 of 11 URLs carry all five |
| Structured Data | 52 | Good - JSON-LD on every page with valid Schema.org vocabulary |
| Heading Quality | 74 | Good - headings present and machine-parseable |
| Consistency | 48% | 48% - same metadata patterns across every page |
...
- Body content ratio averages 55%: pages are content-heavy, not overhead-heavy, which helps agents reach real prose inside a cheap fetch.
...
| 7 | Schema.org coverage is partial: Decoration (SDQ 52/100) | Machine Readability Opportunity | Medium | Medium | Agents can partially parse structured facts but key properties may be missing |
...
| 9 | Intended audience not machine-declared (child audience inferred from content) | Machine Readability Opportunity | Medium | Low | Agents must infer the intended audience from the prose; a declared signal removes the ambiguity and supports age-appropriate routing |
| 10 | Age-assurance signal not machine-detectable (child audience) | Machine Readability Opportunity | Medium | Medium | An agent cannot tell whether age assurance is in place; where one is operated, it is not exposed in a way a machine can read |
| 11 | Consent signal not machine-detectable on first visit (child audience) | Machine Readability Opportunity | Medium | Medium | An agent cannot confirm whether a consent mechanism is presented before processing |
...
**Finding:** This element has insufficient contrast at this conformance level. Expected a contrast ratio of at least 4.5:1, but text in this element has a contrast ratio of 1.64:1. Recommendation:  change text colour to #9f6c00. This pattern appears 35 time(s) across the audited set, affecting low-vision users.
...
**Finding:** Heading levels skip on 11 audited page(s) (for example an h2 followed by an h4), so the document outline a machine or screen reader builds does not match the visible structure.
...
**Finding:** Rendered semantic-structure score 13/100: containers carry no role, ARIA landmark, or descriptive class, so machines fall back on positional inference to determine meaning. The worst page ([/en/worlds](https://sibotacademy.pl/en/worlds)) carries 64 bare divs of 82.
...
**Finding:** 32 Schema.org property gap(s) on the audited set across WebSite: required or recommended properties are missing, so machines extract these entities less reliably.
...
**Priority 7: Schema.org coverage is partial: Decoration (SDQ 52/100)**
...
**Priority 9: Intended audience not machine-declared (child audience inferred from content)**

**Bucket:** Machine Readability Opportunity

**Finding:** Intended audience not machine-declared (child audience inferred from content) (Site-wide). Agents must infer the intended audience from the prose; a declared signal removes the ambiguity and supports age-appropriate routing

**What to change and why:**

- Declare the intended audience with a machine-readable signal so an agent reads who the page is for rather than inferring it from the prose: a schema.org Audience or typicalAgeRange entry in your JSON-LD for an age band, and mx:intendedAgeRange (or mx:audience for a general audience) in your MX metadata.
...
**Priority 10: Age-assurance signal not machine-detectable (child audience)**

**Bucket:** Machine Readability Opportunity

**Finding:** Age-assurance signal not machine-detectable (child audience) (Site-wide). An agent cannot tell whether age assurance is in place; where one is operated, it is not exposed in a way a machine can read
...
**Priority 11: Consent signal not machine-detectable on first visit (child audience)**

**Bucket:** Machine Readability Opportunity

**Finding:** Consent signal not machine-detectable on first visit (child audience) (Site-wide). An agent cannot confirm whether a consent mechanism is presented before processing
...
- **sameAs**: Adding ORCID / Wikidata / LinkedIn links to the Organisation entities gives machines authoritative identity context, and would be added to each Organisation schema block on pages that list your academy’s main entity.  
- **breadcrumb**: Implementing BreadcrumbList schema on deep Course or WebPage entries lets agents navigate hierarchical structure directly, and should be inserted into any page beyond the top-level that currently relies only on URL path for navigation.  
- **potentialAction**: Attaching a potentialAction (e.g., ContactPoint) to Organisation schemas exposes actionable contact methods to machines, and would go in each Organisation schema block where contact details are present.
...
| Check | Result |
|-------|--------|
| URL probed | https://sibotacademy.pl/en |
| HTTP status | 200 |
...
Across the 5 pages we checked, every pattern in the catalogue came back clean: the page semantics that reach the tree match what the page presents visually. This is the state to protect when templates change.
...
**Slowest.** The slowest page is `https://sibotacademy.pl/en/worlds`. A first-time visitor sees the cold-cache cost: the crawler recorded 1525 ms on its initial fetch. **First-visit verdict: Acceptable but elevated**. Three fresh re-probes that followed returned 901ms, 273ms, 222ms, giving a returning-visitor median of **273 ms**. **Returning-visitor verdict: Healthy**.

**Median-load control.** The median-load control page is `https://sibotacademy.pl/en/privacy-policy.html`. A first-time visitor sees the cold-cache cost: the crawler recorded 793 ms on its initial fetch. **First-visit verdict: Healthy**. Three fresh re-probes that followed returned 451ms, 152ms, 304ms, giving a returning-visitor median of **304 ms**. **Returning-visitor verdict: Healthy**.
...
Sitemap: https://sibotacademy.pl/sitemap.xml
```

*The full `robots.txt` (8 lines) is preserved alongside this report as `sibotacademy-pl-en-robots-txt.txt`.*

The robots.txt declares 4 disallow paths; all other paths are open to crawlers and machines. It announces the sitemap, so a machine reading the file can find the URL index directly.
...
The sitemap declares 22 URLs and grades Partial. Lastmod is present but identical across entries, so it reads as a single file-stamp rather than a per-page change signal.

This was a full crawl: the audit reached every page it could discover, and 12 of them are absent from the sitemap (which lists 22). The full set is recorded in the `sibotacademy-pl-en-pages-not-in-sitemap.csv` sidecar alongside this report. Adding them to the sitemap lets search engines and machines discover all content.
...
|--------------|-------|------------|---------------|------------------------------------------|
| Organisation | 6 | 100% | 100% | ContactPoint |
| WebSite | 8 | 100% | 0% | - |
| ContactPoint | 4 | 100% | 100% | OpeningHoursSpecification |
| Course | 3 | 100% | 100% | Organisation, EducationalAudience |
| EducationalAudience | 3 | 100% | 100% | - |
| WebPage | 3 | 100% | 100% | Audience, WebSite |
| AboutPage | 1 | 100% | 100% | WebSite |
| Audience | 1 | 100% | 100% | - |
| ContactPage | 1 | 100% | 100% | WebSite |
| OpeningHoursSpecification | 1 | 100% | 100% | - |

**Structured Data Quality:** 52/100\
**Coverage:** 8 pages with JSON-LD out of 11 total (73%)\
**Unique types:** 10
...
| Required property coverage | 18 | 25 | Every entity carries the properties its type requires |
...
| Cross-entity references | 4 | 15 | Entities reference each other (nested types and @id links) |
...
We identified 32 specific Schema.org property gaps. Each row names a single missing property on a single entity with a short note on why it matters to machines.

The full per-entity list is delivered alongside this report as a sidecar CSV: [`sibotacademy-pl-en-structured-data-findings.csv`](sibotacademy-pl-en-structured-data-findings.csv). The 32 rows describe individual Schema.org property gaps on specific entities; most of them share a small number of underlying patterns, shown below ranked by instance count.
...
|------|----------|----------|----------:|------:|----------------|
| WebSite | recommended | image | 8 | 8 | Site has no logo / hero image declared in structured data |
| WebSite | recommended | datePublished | 8 | 8 | No site-level publish date for crawler context |
| WebSite | recommended | author | 8 | 8 | Site has no top-level author/owner declared |
| WebSite | recommended | publisher | 8 | 8 | Site has no top-level publisher declared |
...
**Age requirement:** the page text names an age band (`7-14`), but it is not declared in machine-readable structured data, so a machine has to infer it. Declaring `schema:typicalAgeRange` or `mx:intendedAgeRange` would let an agent read the band directly.
...
| 2 | Citation | Partial | 50 | Schema.org: Organisation, ContactPoint, WebSite (100% required properties) |
...
Stage 1 (Discovery) is the bottleneck in the agent journey. Because each stage builds on the one before it, the stages after it cannot improve until this one does. It is the highest-priority place to start; the stage's key metric is Crawlable with semantic HTML.
...
- **Truncation Risk** - Pass · 11/11
  - *Means:* Every page is well under the 250 KB hard ceiling at which some server-side agents stop reading, and main content sits within the 50-100 KB offset windows. The largest page is 43 KB ([/en/worlds](https://sibotacademy.pl/en/worlds)).
  - *Data:* Largest page: 43 KB ([/en/worlds](https://sibotacademy.pl/en/worlds)). Thresholds: 250 KB hard ceiling; 50/75/100 KB content-offset windows.
- **SPA Shell** - Fail · 1/11
  ...
  - *Data:* Max gap score: 41. 0 means served and rendered match. Page: https://sibotacademy.pl/en/worlds
- **Soft 404** - Pass · 11/11
...
- **Boilerplate Burial** - Pass · 11/11
  ...
  - *Data:* Highest boilerplate-to-content ratio: 0.54. Threshold: < 10 (and < 80 KB of inline head bytes).
...
- **Body Content Ratio** - Pass · N/A
  - *Means:* Actual prose content averages 55% of served bytes, well above the 30% threshold. Pages are content-heavy, not overhead-heavy.
  - *Data:* Average: 55%. Threshold: 30%.
- **Inline Tag Bloat** - Fail · 3/11
  - *Means:* 3 page(s) carry inline `<style>` or executable `<script>` blocks over 500 bytes. Externalising these to separate .css/.js files lets agents skip them during cheap fetches.
  - *Data:* 25 element(s) > 500 bytes. Largest single-page inline CSS block: 2708 B. Largest single-page inline JS block: 18254 B. See sibotacademy-pl-en-pipeline-inline-tag-bloat-pages.csv (3 pages).
...
We found that Inline Tag Bloat appears on three of the eleven audited pages, meaning machines may miss or misinterpret content because excessive inline styles inflate load time and parsing complexity. A single SPA Shell instance was also flagged, which can hinder a machine’s ability to render dynamic content correctly. Addressing the inline tag bloat by moving styles to external sheets offers the biggest opportunity to strengthen how machines read and index your pages.
...
|--------|--------------|----------------|--------------------|
| Served and rendered | 11/100 (high) | 61 bare divs (81% of containers, depth 8) | `div.w-num` (48), `div.wrap` (36), `div.safety-it` (20), `div.two-col` (19), `div` (17) |

**Worst page (served and rendered are identical):** [/en/worlds](https://sibotacademy.pl/en/worlds)

Across the audited set, the worst page at /en/worlds shows a bare-div ratio of 81 % in the served markup, slightly higher than the 78 % in the rendered markup-these figures refer only to this single page-machines lose structural context and must rely on positional inference to interpret content.  
The soup is structural, with a deepest bare chain of eight elements, indicating that a drag-and-drop builder or untyped component framework injects many nested divs.  
A quick fix is to wrap the obvious landmarks-header, nav, main, footer, aside-and give remaining elements descriptive classes, which will lower the bare-div ratio without changing layout.
...
- **`/en`**: HTTPS Yes · HSTS Yes · CSP No · X-Frame No · X-Content-Type No
- **`/en/index.html`**: HTTPS Yes · HSTS Yes · CSP No · X-Frame No · X-Content-Type No
- **`/en/about.html`**: HTTPS Yes · HSTS Yes · CSP No · X-Frame No · X-Content-Type No
- **`/en/forparents.html`**: HTTPS Yes · HSTS Yes · CSP No · X-Frame No · X-Content-Type No
- **`/en/contact.html`**: HTTPS Yes · HSTS Yes · CSP No · X-Frame No · X-Content-Type No
- **`/index.html`**: HTTPS Yes · HSTS Yes · CSP No · X-Frame No · X-Content-Type No
- **`/en/parent/sign-in`**: HTTPS Yes · HSTS Yes · CSP No · X-Frame No · X-Content-Type No
- **`/en/worlds`**: HTTPS Yes · HSTS Yes · CSP No · X-Frame No · X-Content-Type No
- **`/en/parent/sign-up`**: HTTPS Yes · HSTS Yes · CSP No · X-Frame No · X-Content-Type No
- **`/en/privacy-policy.html`**: HTTPS Yes · HSTS Yes · CSP No · X-Frame No · X-Content-Type No
- **`/en/terms.html`**: HTTPS Yes · HSTS Yes · CSP No · X-Frame No · X-Content-Type No

HTTPS: 11/11 | HSTS: 11/11 | CSP: 0/11 | X-Frame-Options: 0/11 | X-Content-Type-Options: 0/11
...
|----------------------------------|----------|--------------------|
| Schema.org JSON-LD | 73% | 3 |
| MX governance tags | 0% | 11 |
| Open Graph tags | 91% | - |
| Twitter Card tags | 27% | 7 |
| Skip link | 64% | 3 |
...
| Lighthouse heading compliance | 0% | 11 |

**Overall Consistency:** 48%
...
We detected Google Optimise (A/B testing) on https://sibotacademy.pl/en/index.html, https://sibotacademy.pl/en/parent/sign-in, https://sibotacademy.pl/en/privacy-policy.html, https://sibotacademy.pl/en, https://sibotacademy.pl/en/forparents.html and 6 more. During this audit every visit returned the same content, so machines received a consistent variant.

This is a latent risk; if the layer later targets first-touch or uncohorted traffic, machines could start receiving different variants because they arrive without cookies or session data.

- No action needed today: the layer served machines consistent content throughout this audit.  
...
We found 11 identical inline fragment(s) repeated across multiple pages, totalling 20 KB redundant bytes. Extracting these to external CSS or JS files would reduce page weight, improve cacheability, and simplify maintenance.
...
|------|-------------------:|-------------------:|------------------------------------------------------------------|
| js | 266 | 11 | (function(c,l,a,r,i,t,y){c[a]=c[a]\|\|function(){(c[a].q=c[a]. |
| css | 147 | 8 | *,*::before,*::after{box-sizing:border-box}body{margin:0;bac |
| js | 2765 | 3 | self.__next_f.push([1,"\n          html,body{background:#010 |
| css | 2688 | 3 | html,body{background:#010c1a;margin:0}           @keyframes  |
| js | 172 | 3 | (function(){var s=document.getElementById('splash');if(!s)re |
| js | 43 | 3 | (self.__next_f=self.__next_f\|\|[]).push([0]) |
| js | 2465 | 2 | self.__next_f.push([1,"d:[\"$\",\"$L1b\",null,{\"initialStat |
| js | 1221 | 2 | self.__next_f.push([1,"18:[[\"$\",\"meta\",\"0\",{\"charSet\ |
| js | 804 | 2 | self.__next_f.push([1,"\"/_next/static/chunks/0f2yr13wzrupx. |

*The full inventory (every fragment with its hash and the page URLs that carry it) is preserved alongside this report as `sibotacademy-pl-en-inline-code-duplicates.csv`.*
...
We note that accessibility legislation worldwide has converged on ISO 14289-1 (PDF/UA) as the technical baseline, with the European Accessibility Act exemplifying this alignment across the EU, US, UK, Australia and Canada. We also recognise that an untagged PDF remains invisible to machines-search crawlers, AI systems and automated pipelines cannot extract text or structure from a scanned or image-based document, whereas a tagged PDF with a proper structure tree is machine-readable in the same way semantic HTML is.
...
SEO is a clear strength for https://sibotacademy.pl, scoring 87/100 and demonstrating strong optimisation for search engines. Key opportunities lie in Discovery Readiness (32/100) and Structured Data (52/100), where improving metadata will enhance machine comprehension and visibility. We invite you to act on these findings to further elevate the site’s performance for both human visitors and machines.
...
|-----------|-------|------|
| Served-HTML Structure | 81/100 | Excellent |
| Accessibility | 95/100 | Excellent |
| SEO (all pages) | 87/100 | Excellent |
...
| Discovery Readiness | 32/100 | Could Be Better |
| Heading Quality | 74/100 | Good |
| Agent Readability | 60/100 | Good |
| Pipeline Survivability | 97/100 | Excellent |
| Cross-Page Consistency | 48% | Could Be Better |
...
- **`/en`**: SEO 93 · A11y 95 · Back 75 · Served 80 · Rendered 78
- **`/en/index.html`**: SEO 93 · A11y 95 · Back 75 · Served 80 · Rendered 78
- **`/en/about.html`**: SEO 88 · A11y 95 · Back 75 · Served 96 · Rendered 96
- **`/en/forparents.html`**: SEO 94 · A11y 95 · Back 75 · Served 73 · Rendered 71
- **`/en/contact.html`**: SEO 85 · A11y 95 · Back 75 · Served 100 · Rendered 99
- **`/index.html (nav)`**: SEO 98 · A11y 95 · Back 75 · Served 75 · Rendered 73
- **`/en/parent/sign-in`**: SEO 69 · A11y 95 · Back 45 · Served 59 · Rendered 59
- **`/en/worlds`**: SEO 70 · A11y 95 · Back 45 · Served 64 · Rendered 63
- **`/en/parent/sign-up`**: SEO 69 · A11y 95 · Back 45 · Served 59 · Rendered 59
- **`/en/privacy-policy.html`**: SEO 100 · A11y 95 · Back 75 · Served 100 · Rendered 100
- **`/en/terms.html`**: SEO 100 · A11y 95 · Back 75 · Served 100 · Rendered 100
...
Per page, internal links range from 1 to 13, averaging 10 across 9 pages. That is sparser than typical (benchmark median 20 per page).
...
| Link class | Count |
| --- | ---: |
| Same-host internal links (all pages) | 91 |
...
We reviewed 83 images across the audited set: 71 WebP, 8 PNG and 4 in other or unidentified formats. 83 of 83 (100.0%) carry alt text, so every image on the audited pages gives a screen-reader user and a machine reading the page a description to work from.

On loading strategy, 8 images are marked `loading="lazy"` and 0 `loading="eager"`, while 75 carry no loading attribute at all. No attribute is not the same as eager: the browser decides for itself when to fetch, which removes the explicit control that lazy and eager give you. Setting an explicit attribute on those images makes the fetch behaviour predictable for browsers and machines alike.
...
**Scope:** 11 pages examined | Platform: Netlify | Frameworks: **Next.js** (medium confidence) - JS framework; **Tailwind CSS** (medium confidence) - CSS framework; **Netlify** (low confidence) - CDN / delivery | Analysis method: Hybrid (automated + manual verification) | robots.txt: Present (7 directives)
