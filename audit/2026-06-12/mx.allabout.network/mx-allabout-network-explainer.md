...
| 1 | template-voice-check | REPORT | 0.1s | pass |  |
| 2 | infill-pass1 | REPORT | 1.0s | pass |  |
| 3 | rewrite-pass2 | REPORT | 2m 40s | pass |  |
| 4 | engagement-table-regen | REPORT | 0.1s | pass |  |
| 5 | audit-delta-inject | REPORT | 0.1s | pass |  |
| 6 | error-section-regen | REPORT | 0.1s | pass |  |
...
| Metric | Value |
|--------|-------|
| Total elapsed | 2m 41s |
| Steps completed | 6 |
| Steps skipped | 0 |

**Slowest steps:**

1. rewrite-pass2 - 2m 40s
2. infill-pass1 - 1.0s
3. template-voice-check - 0.1s

---

## GATES - 2026-06-12 14:15:03
...
| 14 | gate-1 | GATES | 0.1s | pass |  |
| 15 | gate-2 | GATES | 0.5s | pass |  |
| 16 | gate-3-fierce-critic | GATES | 1m 58s | pass |  |
| 17 | gate-4-llm-judgment | GATES | 2m 3s | pass |  |
| 18 | unified-repair | GATES | 1m 39s | warn |  |
| 19 | gate-4b | GATES | 0.2s | pass |  |
| 20 | gate-4c | GATES | 0.7s | warn | 1 finding(s) |
| 21 | gate-prose-lint | GATES | 0.1s | warn | 72 finding(s) |
| 22 | gate-cross-check | GATES | 1m 0s | warn |  |
| 23 | gate-4d-provenance | GATES | 1m 13s | pass |  |
| 24 | gate-4e-action-findings | GATES | 0.3s | pass |  |
| 25 | gate-5-pdf | GATES | 6.4s | pass | mx-outputs/audit/2026-06-12/mx.allabout.network/mx-allabout-network-report.pdf |
...
1. gate-4-llm-judgment - 2m 3s
2. gate-3-fierce-critic - 1m 58s
3. unified-repair - 1m 39s

---

## COLLECT - 2026-06-13 01:08:36
...
| 4 | clear-results | COLLECT | 0.0s | pass |  |
| 5 | ai-usage-check | COLLECT | 0.2s | pass |  |
| 6 | sitemap-discovery | COLLECT | 0.8s | pass | https://mx.allabout.network/sitemap.xml |
| 7 | sitemap-anomaly | COLLECT | 0.1s | pass |  |
| 8 | crawler | COLLECT | 3.5s | pass |  |
| 9 | url-discovery | COLLECT | 0.4s | pass |  |
| 10 | pdf-topup | COLLECT | 0.1s | pass |  |
| 11 | pdf-sample | COLLECT | 0.6s | pass |  |
| 12 | error-page-test | COLLECT | 0.7s | pass |  |
| 13 | agent-access-test | COLLECT | 21.7s | pass |  |
| 14 | served-rendered-gap | COLLECT | 0.1s | pass |  |
| 15 | slowest-page-probe | COLLECT | 5m 27s | pass |  |
| 16 | ab-test-detection | COLLECT | 0.8s | pass | Dynamic Yield, Unbounce Smart Traffic detected (layer present, no variance observed this run) |
| 17 | framework-detection | COLLECT | 0.7s | pass | 6 framework(s) detected: React (low), Next.js (low), Bootstrap (medium), Tailwind CSS (low) … |
| 18 | freshness-expiry-detection | COLLECT | 0.2s | pass | 1/162 page(s) declare expires, 0 already past |
| 19 | a11y-tree-check | COLLECT | 0.8s | pass | 9 page(s), 0 cluster(s) (0 template-level), score 100/100 |
| 20 | provenance-gap-deterministic | COLLECT | 1.2s | pass |  |
| 21 | provenance-gap-llm | COLLECT | 0.7s | pass |  |
| 22 | audience-classify | COLLECT | 0.6s | pass |  |
| 23 | readability-penalties | COLLECT | 0.1s | pass |  |
| 24 | generate-preflight | COLLECT | 0.1s | pass |  |
...
1. slowest-page-probe - 5m 27s
2. agent-access-test - 21.7s
3. crawler - 3.5s

---

## GATES - 2026-06-13 08:52:27
...
| 18 | unified-repair | GATES | 1m 25s | warn |  |
| 19 | gate-4b | GATES | 0.1s | pass |  |
| 20 | gate-4c | GATES | 0.8s | warn | 1 finding(s) |
| 21 | gate-prose-lint | GATES | 0.1s | warn | 73 finding(s) |
| 22 | gate-4d-provenance | GATES | 1m 35s | pass |  |
| 23 | gate-4e-action-findings | GATES | 0.3s | pass |  |
| 24 | gate-5-pdf | GATES | 7.3s | pass | mx-outputs/audit/2026-06-12/mx.allabout.network/mx-allabout-network-report.pdf |
