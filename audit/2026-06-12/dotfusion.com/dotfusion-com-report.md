...
Across the audited set, your site delivers a solid human experience. The SEO foundations are excellent, with an 84/100 score that shows keyword-rich content and clear navigation. Visitors find what they need quickly, reinforcing brand trust.

The opportunity we want to draw attention to is twofold. First, accessibility presents a Priority 1 compliance item; six distinct WCAG AA issue types generate 100 raw instances, with 60 tied to recurring template patterns that can be resolved in one change per pattern. Second, the headline machine-experience step is to elevate discovery readiness and governance. Discovery Readiness sits at 20/100, and no MX governance markers are present across the audited set. Adding full MX fields-mx:status, mx:contentType, mx:audience, canonicalUri, provenance markers-will give machines the structured context they need for accurate comprehension and lift the site from Level 1 Discoverable to Level 2 Governed.

Because the site runs on Netlify, served HTML is already fully parseable by machines (AI Suitability 100/100), so the focus shifts to governance and accessibility.

\clearpage

<!-- AUDIT-DELTA:START -->
## Change Since Our 5 June 2026 Audit

We last audited dotfusion.com on 5 June 2026. The table compares that audit with the current one across the headline measures. Some scores improved, the rest held steady, and none declined; the table shows each change.

| Measure | 5 June 2026 | 12 June 2026 | Change |
|---------|------:|------:|:-------|
| Performance | 35 | 55 | +20 (improved) |
| Accessibility | 73 | 73 | No change |
| SEO | 81 | 84 | +3 (improved) |
| Machine Suitability | 100 | 100 | No change |
| WCAG AA issues | 517 | 100 | -417 (improved) |
| Pages audited | 22 | 12 | -10 |
...
Across the audited set, the pages deliver a strong experience for human visitors, with performance averaging 2532 ms, accessibility scoring 73/100, and SEO at 84/100.
...
Across the audited set, machines can discover and parse your content with a Discovery Readiness of 20/100 and Structured Data Quality of 44/100, but lack governance context as indicated by an MX Readiness Level of 1 (Discoverable) and MX Stack Completeness of 43/100, while Pipeline Survivability remains high at 95/100.
...
Across the audited set, your pages demonstrate a strong foundations in SEO (84/100) and accessibility (73/100), with consistent template-level patterns and respectable structured-data quality (44/100) that lay the groundwork for further enhancements.
...
- **sameAs**: link your Organisation entity to external authority IDs such as LinkedIn or Wikidata; this gives machines a verified identity anchor that improves disambiguation across search results.  
- **potentialAction**: add a “Contact” action to your Organisation’s ContactPoint data; this lets agents understand how to reach you directly and can surface contact options in voice assistants.  
- **BreadcrumbList**: embed breadcrumb markup on deep pages that currently rely only on URL path; this provides machines with explicit navigation context, improving search result snippets and breadcrumb displays.
...
We found a truncation risk on five of the twelve audited pages, meaning that automated agents may stop reading before they reach all of your content. This limits what machines can understand and index from those pages. Addressing the truncation by reducing page size or adjusting fetch offsets will give machines full access to the content and has the biggest impact.
...
We observed that both the served and rendered surfaces of the worst page, https://dotfusion.com/about, exhibit a high bare-div ratio of 73%, meaning machines lose structural context and must rely on positional inference to determine meaning.  
The soup is surface-wide, characterised by shallow chains of depth five despite the high bare-div ratio, indicating that the source pipeline likely relies on drag-and-drop builders or untyped component frameworks that inject many generic divs without semantic markup.  
...
We note that accessibility legislation converges on ISO 14289-1 (PDF/UA) as the technical baseline across major markets, with the EAA Directive in the EU serving as a precisely codified example of this global alignment.  
We also observe that an untagged PDF remains invisible to AI agents and search crawlers, whereas a tagged PDF with a proper structure tree is machine-readable just like semantic HTML.
...
We found that https://dotfusion.com scores a perfect 100/100 for AI Suitability, indicating it is fully ready for machine consumption and can deliver high-value insights to machines. Across the audited set, Discovery Readiness sits at 20/100 and Structured Data at 44/100, highlighting opportunities to expose metadata and discovery artefacts that will improve machine understanding. We invite you to address these gaps to unlock greater visibility and engagement for your content.
