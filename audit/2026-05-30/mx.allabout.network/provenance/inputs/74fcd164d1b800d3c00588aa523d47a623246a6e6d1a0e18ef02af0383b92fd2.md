...
| Metric | Count |
|--------|-------|
| AI crawler hits (GPTBot, ClaudeBot, PerplexityBot, Google-Extended, …) | 1323 |
| AI referral hits (human visits from chat surfaces) | 1 |
| Total AI-attributable visits | 1324 |

**Top referring AI surfaces:**

| Agent | Event Type | Hits |
|-------|-----------|------|
| amazonbot | crawler | 504 |
| chatgpt | crawler | 258 |
| claude | crawler | 208 |
| meta-ai | crawler | 193 |
| ccbot | crawler | 79 |
| bytespider | crawler | 37 |
| perplexity | crawler | 30 |
| gemini | crawler | 13 |
| claude | referral | 1 |
| you | crawler | 1 |
