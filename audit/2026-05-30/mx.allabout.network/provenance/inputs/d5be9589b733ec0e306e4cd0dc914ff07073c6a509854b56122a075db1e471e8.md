...
| Metric | Count |
|--------|-------|
| AI crawler hits (GPTBot, ClaudeBot, PerplexityBot, Google-Extended, …) | 1338 |
| AI referral hits (human visits from chat surfaces) | 1 |
| Total AI-attributable visits | 1339 |

**Top referring AI surfaces:**

| Agent | Event Type | Hits |
|-------|-----------|------|
| amazonbot | crawler | 506 |
| chatgpt | crawler | 262 |
| claude | crawler | 210 |
| meta-ai | crawler | 193 |
| ccbot | crawler | 81 |
| bytespider | crawler | 38 |
