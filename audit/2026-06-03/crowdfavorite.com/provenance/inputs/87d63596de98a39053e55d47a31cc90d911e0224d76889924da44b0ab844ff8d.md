...
Across the audited set, we present key opportunities for strengthening machine comprehension and discoverability, prioritized by impact. Discovery readiness gaps rank highest because they impede all downstream processes, followed by catalogue visibility which limits content exposure, then MX stack completeness and structured data quality.
