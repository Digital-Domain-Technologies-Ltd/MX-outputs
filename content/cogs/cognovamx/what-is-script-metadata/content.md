...
- **No documentation in The Protocols.** The concept exists in Canon (specifications, cogs) but not yet in the practitioner-facing book.
...
3. **Document in The Protocols.** Write the practitioner-facing explanation: what script metadata is, how to add it, how to use mx.inspect.sh, the three-tier read strategy.
