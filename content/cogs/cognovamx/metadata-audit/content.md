    ...
    actions:
      - name: audit
        ...
        usage: |
          ...
          7. Scans prose for namespace attribution errors (mx: belongs to The Gathering, not CogNovaMX)
...
| **Namespace errors** | Documents that incorrectly say `mx:` belongs to CogNovaMX (it belongs to The Gathering) |
...
| CogNovaMX public | `x-mx-` | CogNovaMX |
| CogNovaMX private | `x-mx-p-` | CogNovaMX |
