...
| **Canonical location** | `scripts/cogs/what-is-a-cog.cog.md` |
...
| **Canonical location** | `scripts/cogs/who-is-maxine.cog.md` |
| **Copies** | mx-canon/mx-the-gathering/deliverables/, mx-reginald/examples/ |
...
| **Canonical location** | `scripts/cogs/what-is-mx-os.cog.md` |
...
| **Canonical location** | `scripts/cogs/cog-registry.cog.md` |
...
| **Builds-on** | what-is-a-cog, what-is-mx-os |
| **Canonical location** | `scripts/cogs/cogs-for-agent-developers.cog.md` |
| **Copies** | mx-canon/mx-the-gathering/deliverables/, mx-reginald/examples/ |
...
| **Canonical location** | `scripts/cogs/what-comes-next.cog.md` |
...
| **Canonical location** | `scripts/cogs/how-mx-os-runs.cog.md` |
| **Copies** | *(none — canonical only)* |
...
| **Canonical location** | `scripts/cogs/access-and-guardrails.cog.md` |
| **Copies** | *(none — canonical only)* |
...
| **Canonical location** | `scripts/cogs/the-companion-web.cog.md` |
| **Copies** | *(none — canonical only)* |
...
| **Canonical location** | `scripts/cogs/the-personal-cog.cog.md` |
| **Copies** | *(none — canonical only)* |
...
| **Canonical location** | `scripts/cogs/asking-for-help.cog.md` |
| **Copies** | *(none — canonical only)* |
...
| **Canonical location** | `scripts/cogs/building-action-docs.cog.md` |
| **Copies** | *(none — canonical only)* |
...
| **Canonical location** | `scripts/cogs/script-helper.cog.md` |
| **Copies** | *(none — canonical only)* |
...
| **Canonical location** | `scripts/cogs/what-is-script-metadata.cog.md` |
| **Copies** | *(none — canonical only)* |
...
| **Builds-on** | what-is-a-cog, what-is-mx-os, how-mx-os-runs |
| **Refers-to** | cog-unified-spec, mx-principles |
| **Canonical location** | `scripts/cogs/what-is-mx-environment.cog.md` |
| **Copies** | *(none — canonical only)* |
...
| **Refers-to** | cog-unified-spec, mx-principles |
| **Canonical location** | `scripts/cogs/what-is-installme.cog.md` |
| **Copies** | *(none — canonical only)* |
...
| **Canonical location** | `scripts/cogs/installme-runner.cog.md` |
| **Copies** | *(none — canonical only)* |
...
| **Refers-to** | cog-unified-spec, mx-principles |
| **Actions** | list, find |
| **Canonical location** | `scripts/cogs/mx-os/mx-phrasebook.cog.md` |
| **Copies** | *(none — canonical only)* |
...
| **Canonical location** | `scripts/cogs/mx-init.cog.md` |
| **Copies** | *(none — canonical only)* |
