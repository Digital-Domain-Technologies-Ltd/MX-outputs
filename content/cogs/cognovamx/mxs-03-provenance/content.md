...
- This field relates to the AI generation fields in the [MX AI/Agent Policy Standard](mxs-04-ai-agent-policy.cog.md). Where `provenanceOrigin` declares how content was created, AI policy fields govern how agents may interact with it.
...
- [MX AI/Agent Policy Standard](mxs-04-ai-agent-policy.cog.md) — AI governance and agent policies (related to `provenanceOrigin`)
