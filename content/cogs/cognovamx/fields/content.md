...
mx:
  ...
  namespacePolicy:
    ...
    convention: "x- follows HTTP extension header convention. mx- identifies CogNovaMX. p- identifies private/obfuscated. The prefix is the policy — no additional visibility markers needed."
    ...
    context-specific-naming:
      ...
      namespace-equivalence:
        ...
        note: "The mx: namespace belongs to The Gathering (open standard), not CogNovaMX. See governance section in mx-standards-alignment.cog.md."
  ...
  fields:
    ...
    # Public vendor extensions belonging to CogNovaMX.
...
| **x-mx-public** | CogNovaMX vendor extensions | `x-mx-mount-type`, `x-mx-mount-swappable` |
...
Standard fields have no prefix — they belong to everyone. CogNovaMX' own extensions use `x-mx-` (public) or `x-mx-p-` (private/obfuscated). This follows HTTP extension header convention and keeps the standard namespace clean.
...
| **MX-public** | `x-mx-` | CogNovaMX | Anyone reading the cog. Visible but non-standard. |
| **MX-private** | `x-mx-p-` | CogNovaMX | Only `$MX_HOME` registry holders. Values are obfuscated. |

The prefix tells you everything. `x-` means "extension, not the standard." `mx-` means "this extension belongs to CogNovaMX." `p-` means "private — the value is meaningless without the decode registry."
...
### Vendor extension fields (CogNovaMX)
...
5. **No Gathering approval needed** — vendor extensions are CogNovaMX's decision
...
mx:
  rights:
    ...
    holder: "CogNovaMX Ltd"
    commercial: false
    attribution: "Credit required: Tom Cranstoun / CogNovaMX"
