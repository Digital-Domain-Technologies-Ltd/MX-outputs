...
mx:
  ...
  - what-is-mx-os
  contentType: adr
  runbook: 'This is ADR #1 for the Maxine Lives initiative. It records the decision to move from two cog types to one document
    type with blocks. Read this for architectural context. For the full interview transcript, see the deliverables folder.'
---
