...
INSTALLME.md is a convention, not a standard. It is not governed by The Gathering (yet). It is proposed by CogNovaMX as a practical solution to a real problem: AI agents waste enormous compute trying to install repositories because installation instructions are written for humans.
