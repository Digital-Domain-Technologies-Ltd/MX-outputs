...
If a field would be useful to every implementation (not just CogNovaMX), propose it to The Gathering. Standard fields have no prefix — they belong to everyone. Examples: `name`, `version`, `description`.
...
Is this field useful to ALL implementations?
  ...
  └── NO → Is this an CogNovaMX product field?
...
*Implementation spec for CogNovaMX. Built on The Gathering cog unified spec v2.1-draft.*
